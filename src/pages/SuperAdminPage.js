                        ...
                        : 'border-transparent text-gray-600 hover:text-gray-900'}`, children: [tab === 'overview' && 'Vue d\'ensemble', tab === 'organizations' && 'Organisations', tab === 'users' && 'Utilisateurs', tab === 'revenue' && 'Revenus', tab === 'support' && 'Support', tab === 'billing' && 'Facturation', tab === 'whitelabel' && 'White Label', tab === 'echoes' && 'Echoes', tab === 'config' && 'Configuration'] }, tab))) }), activeTab === 'overview' && (_jsxs("div", { className: "space-y-6", children: [_jsxs("div", { className: "grid gap-4 sm:grid-cols-2 lg:grid-cols-5", children: [_jsx(Card, { children: _jsx(CardContent, { className: "pt-6", children: statsLoading ? (_jsxs(_Fragment, { children: [_jsx(Skeleton, { className: "h-6 w-20 mb-2" }), _jsx(Skeleton, { className: "h-8 w-16" })] })) : (_jsx(_Fragment, { children: _jsxs("div", { className: "flex items-center justify-between", children: [_jsxs("div", { children: [_jsx("p", { className: "text-sm text-gray-600", children: "Utilisateurs totaux" }), _jsx("p", { className: "mt-2 text-2xl font-bold text-gray-900", children: stats?.totalUsers || 0 })] }), _jsx(Users, { className: "h-8 w-8 text-blue-600 opacity-20" })] }) })) }) }), _jsx(Card, { children: _jsx(CardContent, { className: "pt-6", children: statsLoading ? (_jsxs(_Fragment, { children: [_jsx(Skeleton, { className: "h-6 w-20 mb-2" }), _jsx(Skeleton, { className: "h-8 w-16" })] })) : (_jsx(_Fragment, { children: _jsxs("div", { className: "flex items-center justify-between", children: [_jsxs("div", { children: [_jsx("p", { className: "text-sm text-gray-600", children: "Organisations" }), _jsx("p", { className: "mt-2 text-2xl font-bold text-gray-900", children: stats?.totalOrganizations || 0 })] }), _jsx(Building2, { className: "h-8 w-8 text-green-600 opacity-20" })] }) })) }) }), _jsx(Card, { children: _jsx(CardContent, { className: "pt-6", children: statsLoading ? (_jsxs(_Fragment, { children: [_jsx(Skeleton, { className: "h-6 w-20 mb-2" }), _jsx(Skeleton, { className: "h-8 w-16" })] })) : (_jsx(_Fragment, { children: _jsxs("div", { className: "flex items-center justify-between", children: [_jsxs("div", { children: [_jsx("p", { className: "text-sm text-gray-600", children: "V\u00E9hicules totaux" }), _jsx("p", { className: "mt-2 text-2xl font-bold text-gray-900", children: stats?.totalVehicles || 0 })] }), _jsx(BarChart3, { className: "h-8 w-8 text-purple-600 opacity-20" })] }) })) }) }), _jsx(Card, { children: _jsx(CardContent, { className: "pt-6", children: statsLoading ? (_jsxs(_Fragment, { children: [_jsx(Skeleton, { className: "h-6 w-20 mb-2" }), _jsx(Skeleton, { className: "h-8 w-16" })] })) : (_jsx(_Fragment, { children: _jsxs("div", { className: "flex items-center justify-between", children: [_jsxs("div", { children: [_jsx("p", { className: "text-sm text-gray-600", children: "Traceurs actifs" }), _jsx("p", { className: "mt-2 text-2xl font-bold text-gray-900", children: stats?.activeTrackers || 0 })] }), _jsx(Activity, { className: "h-8 w-8 text-orange-600 opacity-20" })] }) })) }) }), _jsx(Card, { children: _jsx(CardContent, { className: "pt-6", children: statsLoading ? (_jsxs(_Fragment, { children: [_jsx(Skeleton, { className: "h-6 w-20 mb-2" }), _jsx(Skeleton, { className: "h-8 w-16" })] })) : (_jsx(_Fragment, { children: _jsxs("div", { className: "flex items-center justify-between", children: [_jsxs("div", { children: [_jsx("p", { className: "text-sm text-gray-600", children: "Alertes actives" }), _jsx("p", { className: "mt-2 text-2xl font-bold text-gray-900", children: stats?.activeAlerts || 0 })] }), _jsx(AlertTriangle, { className: "h-8 w-8 text-red-600 opacity-20" })] }) })) }) })] }), _jsxs(Card, { children: [_jsxs(CardHeader, { children: [_jsxs(CardTitle, { className: "flex items-center gap-2", children: [_jsx(Wifi, { className: "h-5 w-5" }), "V\u00E9rifications sant\u00E9 connexion"] }), _jsx(CardDescription, { children: "\u00C9tat de connexion des fournisseurs GPS" })] }), _jsx(CardContent, { children: _jsx("div", { className: "space-y-3", children: gpsProviderHealth.map(provider => (_jsx("div", { className: "flex items-center justify-between rounded-lg border border-gray-200 p-4", children: _jsxs("div", { className: "flex items-center gap-3", children: [provider.status === 'connected' && (_jsxs(_Fragment, { children: [_jsx("div", { className: "h-3 w-3 rounded-full bg-green-600" }), _jsx("span", { className: "text-sm font-medium text-gray-900", children: provider.name }), _jsxs("span", { className: "text-xs text-green-600", children: ["Connect\u00E9 \u2014 ", provider.latency, "ms"] })] })), provider.status === 'degraded' && (_jsxs(_Fragment, { children: [_jsx("div", { className: "h-3 w-3 rounded-full bg-yellow-600" }), _jsx("span", { className: "text-sm font-medium text-gray-900", children: provider.name }), _jsxs("span", { className: "text-xs text-yellow-600", children: ["Latence \u00E9lev\u00E9e \u2014 ", provider.latency, "ms"] })] })), provider.status === 'disconnected' && (_jsxs(_Fragment, { children: [_jsx("div", { className: "h-3 w-3 rounded-full bg-red-600" }), _jsx("span", { className: "text-sm font-medium text-gray-900", children: provider.name }), _jsx("span", { className: "text-xs text-red-600", children: "D\u00E9connect\u00E9" })] }))] }) }, provider.name))) }) })] }), _jsxs(Card, { children: [_jsxs(CardHeader, { children: [_jsxs(CardTitle, { className: "flex items-center gap-2", children: [_jsx(Shield, { className: "h-5 w-5" }), "Sant\u00E9 du syst\u00E8me"] }), _jsx(CardDescription, { children: "\u00C9tat en temps r\u00E9el des composants critiques" })] }), _jsx(CardContent, { children: healthLoading ? (_jsx("div", { className: "grid gap-4 sm:grid-cols-3", children: [1, 2, 3].map(i => (_jsx(Skeleton, { className: "h-32" }, i))) })) : (_jsxs("div", { className: "grid gap-4 sm:grid-cols-3", children: [_jsxs("div", { className: `rounded-lg p-4 ${getStatusColor(health?.api?.status || 'down')}`, children: [_jsxs("div", { className: "flex items-center gap-2 mb-3", children: [_jsx(Server, { className: "h-5 w-5" }), _jsx("p", { className: `text-sm font-medium ${getStatusTextColor(health?.api?.status || 'down')}`, children: "Serveur API" })] }), _jsxs("div", { className: "space-y-1", children: [_jsxs("div", { className: "flex items-center gap-2", children: [getStatusIcon(health?.api?.status || 'down'), _jsx("span", { className: "font-semibold text-gray-900 capitalize", children: health?.api?.status || 'Unknown' })] }), _jsxs("p", { className: "text-xs text-gray-600", children: ["R\u00E9ponse : ", health?.api?.responseTime, "ms"] }), _jsxs("p", { className: "text-xs text-gray-600", children: ["Derni\u00E8re v\u00E9rif. : ", health?.api?.lastCheck ? formatTimeAgo(new Date(health.api.lastCheck)) : 'N/A'] })] })] }), _jsxs("div", { className: `rounded-lg p-4 ${getStatusColor(health?.database?.status || 'down')}`, children: [_jsxs("div", { className: "flex items-center gap-2 mb-3", children: [_jsx(Database, { className: "h-5 w-5" }), _jsx("p", { className: `text-sm font-medium ${getStatusTextColor(health?.database?.status || 'down')}`, children: "Base de donn\u00E9es" })] }), _jsxs("div", { className: "space-y-1", children: [_jsxs("div", { className: "flex items-center gap-2", children: [getStatusIcon(health?.database?.status || 'down'), _jsx("span", { className: "font-semibold text-gray-900 capitalize", children: health?.database?.status || 'Unknown' })] }), _jsxs("p", { className: "text-xs text-gray-600", children: ["R\u00E9ponse : ", health?.database?.responseTime, "ms"] }), _jsxs("p", { className: "text-xs text-gray-600", children: ["Connexions : ", health?.database?.connections || 0] })] })] }), _jsxs("div", { className: `rounded-lg p-4 ${getStatusColor(health?.gpsProviders?.status || 'down')}`, children: [_jsxs("div", { className: "flex items-center gap-2 mb-3", children: [_jsx(Wifi, { className: "h-5 w-5" }), _jsx("p", { className: `text-sm font-medium ${getStatusTextColor(health?.gpsProviders?.status || 'down')}`, children: "Fournisseurs GPS" })] }), _jsxs("div", { className: "space-y-1", children: [_jsxs("div", { className: "flex items-center gap-2", children: [getStatusIcon(health?.gpsProviders?.status || 'down'), _jsx("span", { className: "font-semibold text-gray-900 capitalize", children: health?.gpsProviders?.status || 'Unknown' })] }), _jsxs("p", { className: "text-xs text-gray-600", children: ["Actifs : ", health?.gpsProviders?.activeTrackers || 0] }), _jsxs("p", { className: "text-xs text-gray-600", children: ["Mis \u00E0 jour : ", health?.gpsProviders?.lastUpdate ? formatTimeAgo(new Date(health.gpsProviders.lastUpdate)) : 'N/A'] })] })] })] })) })] }), statsLoading ? (_jsxs(Card, { children: [_jsx(CardHeader, { children: _jsx(Skeleton, { className: "h-6 w-40" }) }), _jsx(CardContent, { children: _jsxs("div", { className: "space-y-3", children: [_jsx(Skeleton, { className: "h-16" }), _jsx(Skeleton, { className: "h-16" })] }) })] })) : (_jsxs(Card, { children: [_jsx(CardHeader, { children: _jsxs(CardTitle, { className: "flex items-center gap-2", children: [_jsx(Activity, { className: "h-5 w-5" }), "Performance syst\u00E8me"] }) }), _jsx(CardContent, { children: _jsxs("div", { className: "grid gap-4 sm:grid-cols-2", children: [_jsxs("div", { className: "rounded-lg border border-gray-200 p-4", children: [_jsx("p", { className: "text-sm text-gray-600", children: "Disponibilit\u00E9" }), _jsx("p", { className: "mt-2 text-xl font-semibold text-gray-900", children: stats?.uptime ? `${(stats.uptime * 100).toFixed(2)}%` : 'N/A' })] }), _jsxs("div", { className: "rounded-lg border border-gray-200 p-4", children: [_jsx("p", { className: "text-sm text-gray-600", children: "Requ\u00EAtes par seconde" }), _jsxs("p", { className: "mt-2 text-xl font-semibold text-gray-900", children: [stats?.requestsPerSecond || 0, " RPS"] })] })] }) })] }))] })), activeTab === 'organizations' && (_jsxs("div", { className: "space-y-6", children: [_jsxs("div", { className: "flex items-center gap-2", children: [_jsx(Search, { className: "h-5 w-5 text-gray-400" }), _jsx(Input, { placeholder: "Rechercher par nom ou ID...", value: searchOrg, onChange: e => setSearchOrg(e.target.value), className: "flex-1" }), _jsxs(Button, { variant: "outline", size: "sm", className: "gap-2", onClick: () => openOrgModal(), children: [_jsx(Plus, { className: "h-4 w-4" }), "Cr\u00E9er une organisation"] })] }), _jsx("div", { className: "flex gap-2", children: ['all', 'active', 'paused', 'suspended'].map(status => (_jsx(Button, { variant: orgStatusFilter === status ? 'default' : 'outline', size: "sm", onClick: () => setOrgStatusFilter(status), children: status === 'all' ? 'Tous' : status === 'active' ? 'Actif' : status === 'paused' ? 'En pause' : 'Suspendu' }, status))) }), orgsLoading ? (_jsx("div", { className: "space-y-3", children: [1, 2, 3].map(i => (_jsx(Skeleton, { className: "h-20" }, i))) })) : (_jsxs(Card, { children: [_jsxs(CardHeader, { children: [_jsxs(CardTitle, { children: ["Organisations (", filteredOrganizations.length, ")"] }), _jsx(CardDescription, { children: "G\u00E9rer toutes les organisations du syst\u00E8me" })] }), _jsx(CardContent, { children: _jsx("div", { className: "space-y-3", children: filteredOrganizations.length === 0 ? (_jsx("p", { className: "text-center text-gray-600 py-8", children: "Aucune organisation trouv\u00E9e" })) : (filteredOrganizations.map(org => {
                                        ...
                                        return (_jsxs("div", { className: "flex flex-col rounded-lg border border-gray-200 p-4 hover:border-gray-300 transition-colors space-y-3", children: [_jsxs("div", { className: "flex items-start justify-between", children: [_jsxs("div", { className: "flex-1", children: [_jsx("p", { className: "font-medium text-gray-900", children: org.name }), _jsxs("p", { className: "text-sm text-gray-600 mt-1", children: [org.users, " utilisateurs \u2022 ", org.vehicles, " v\u00E9hicules"] }), _jsxs("p", { className: "text-xs text-gray-500 mt-1", children: ["Cr\u00E9\u00E9 ", formatTimeAgo(new Date(org.createdAt)), " \u2022 Derni\u00E8re activit\u00E9", ' ', formatTimeAgo(new Date(org.lastActivity))] })] }), _jsx("div", { className: "flex items-center gap-2", children: _jsx(Badge, { variant: org.plan === 'Pro' || org.plan === 'Enterprise' ? 'default' : 'secondary', className: "capitalize", children: org.plan }) })] }), _jsxs("div", { className: "flex items-center justify-between pt-2 border-t border-gray-200", children: [_jsx("div", { className: "flex-1", children: _jsxs("p", { className: "text-xs text-gray-600", children: ["Facturation : ", org.plan, " \u2014 Prochaine \u00E9ch\u00E9ance : 01/05/2026"] }) }), _jsxs("div", { className: "flex items-center gap-2", children: [_jsx(Button, { variant: isSuspended ? 'default' : 'outline', size: "sm", onClick: () => toggleOrgSuspend(org.id), className: isSuspended ? 'gap-1' : 'gap-1', children: isSuspended ? (_jsxs(_Fragment, { children: [_jsx(Power, { className: "h-4 w-4" }), "Activer"] })) : (_jsxs(_Fragment, { children: [_jsx(Power, { className: "h-4 w-4" }), "Suspendre"] })) }), _jsx(Badge, { variant: org.status === 'active' && !isSuspended ? 'default' : 'secondary', className: "capitalize", children: isSuspended ? 'Suspendu' : org.status }), _jsxs(Button, { variant: "outline", size: "sm", className: "gap-1", onClick: () => openOrgModal(org), children: [_jsx(Eye, { className: "h-4 w-4" }), "\u00C9diter"] }), _jsxs(Button, { variant: "outline", size: "sm", className: "gap-1 text-red-600 hover:bg-red-50", onClick: () => deleteOrganization(org.id), children: [_jsx(AlertTriangle, { className: "h-4 w-4" }), "Supprimer"] })] })] })] }, org.id));
                                                    ...
                                                    .map(ticket => (_jsx("button", { onClick: () => setSelectedTicket(ticket), className: `w-full text-left p-3 rounded-lg border transition-colors ${selectedTicket?.id === ticket.id
                                                        ...
                                                        : 'border-gray-200 hover:border-gray-300'}`, children: _jsxs("div", { className: "flex items-start justify-between gap-2", children: [_jsxs("div", { className: "min-w-0 flex-1", children: [_jsx("p", { className: "text-xs font-medium text-gray-600", children: ticket.id }), _jsx("p", { className: "text-sm font-medium text-gray-900 truncate", children: ticket.subject }), _jsx("p", { className: "text-xs text-gray-600 mt-1", children: ticket.organizationName })] }), _jsx(Badge, { variant: ticket.priority === 'critique'
                                                                    ? 'destructive'
                                                                    ...
                                                                    : selectedTicket.status === 'en cours'
                                                                        ? 'secondary'
                                                                        : 'outline', children: selectedTicket.status === 'ouvert' ? 'Ouvert' : selectedTicket.status === 'en cours' ? 'En cours' : 'Résolu' })] }), _jsxs("div", { className: "grid grid-cols-2 gap-4 text-sm", children: [_jsxs("div", { children: [_jsx("p", { className: "text-gray-600", children: "Organisation" }), _jsx("p", { className: "font-medium", children: selectedTicket.organizationName })] }), _jsxs("div", { children: [_jsx("p", { className: "text-gray-600", children: "Cr\u00E9\u00E9" }), _jsx("p", { className: "font-medium", children: formatTimeAgo(new Date(selectedTicket.createdAt)) })] }), _jsxs("div", { children: [_jsx("p", { className: "text-gray-600", children: "Assign\u00E9 \u00E0" }), _jsx("p", { className: "font-medium", children: selectedTicket.assignedTo || 'Non assigné' })] }), _jsxs("div", { children: [_jsx("p", { className: "text-gray-600", children: "Derni\u00E8re mise \u00E0 jour" }), _jsx("p", { className: "font-medium", children: formatTimeAgo(new Date(selectedTicket.lastUpdate)) })] })] }), selectedTicket.status !== 'résolu' && (_jsxs("div", { className: "flex gap-2 mt-4", children: [_jsxs("select", { value: selectedTicket.status, onChange: (e) => {
                                                                    const newStatus = e.target.value;
                                                                    const updated = { ...selectedTicket, status: newStatus };
                                                                    setSelectedTicket(updated);
                                                                }, className: "px-3 py-2 border border-gray-300 rounded-lg text-sm", children: [_jsx("option", { value: "ouvert", children: "Ouvert" }), _jsx("option", { value: "en cours", children: "En cours" }), _jsx("option", { value: "r\u00E9solu", children: "R\u00E9solu" })] }), _jsxs(Button, { size: "sm", onClick: closeTicket, className: "gap-1", children: [_jsx(CheckCircle, { className: "h-4 w-4" }), "Fermer"] })] }))] }) }), _jsx(CardContent, { children: _jsxs("div", { className: "space-y-4", children: [_jsxs("div", { children: [_jsx("p", { className: "text-sm font-medium text-gray-700 mb-2", children: "R\u00E9ponses" }), _jsxs("div", { className: "space-y-3 max-h-48 overflow-y-auto", children: [_jsxs("div", { className: "bg-gray-50 rounded-lg p-3", children: [_jsx("p", { className: "text-xs text-gray-600 mb-1", children: "Client - 2026-04-01 10:30" }), _jsx("p", { className: "text-sm text-gray-900", children: "Nous avons un probl\u00E8me urgent avec l'int\u00E9gration GPS." })] }), _jsxs("div", { className: "bg-blue-50 rounded-lg p-3", children: [_jsx("p", { className: "text-xs text-gray-600 mb-1", children: "Support - 2026-04-01 11:00" }), _jsx("p", { className: "text-sm text-gray-900", children: "Merci de nous signaler ce probl\u00E8me. Nous enqu\u00EAtons." })] })] })] }), _jsxs("div", { children: [_jsx("p", { className: "text-sm font-medium text-gray-700 mb-2", children: "Ajouter une r\u00E9ponse" }), _jsx("textarea", { value: ticketReply, onChange: e => setTicketReply(e.target.value), placeholder: "Tapez votre r\u00E9ponse...", className: "w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500", rows: 3 }), _jsxs(Button, { className: "mt-2 gap-2", onClick: submitTicketReply, children: [_jsx(Send, { className: "h-4 w-4" }), "Envoyer la r\u00E9ponse"] })] })] }) })] })) : (_jsx(Card, { className: "flex items-center justify-center h-96", children: _jsx("p", { className: "text-gray-500", children: "S\u00E9lectionnez un ticket pour voir les d\u00E9tails" }) })) })] })] })), activeTab === 'billing' && (_jsxs("div", { className: "space-y-6", children: [_jsxs("div", { children: [_jsx("label", { className: "block text-sm font-medium text-gray-700 mb-2", children: "S\u00E9lectionner une organisation" }), _jsx("select", { value: selectedOrgForBilling, onChange: e => setSelectedOrgForBilling(e.target.value), className: "w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500", children: organizations.map(org => (_jsx("option", { value: org.id, children: org.name }, org.id))) })] }), _jsxs("div", { className: "grid gap-4 sm:grid-cols-2 lg:grid-cols-3", children: [_jsx(Card, { children: _jsx(CardContent, { className: "pt-6", children: _jsxs("div", { className: "space-y-2", children: [_jsx("p", { className: "text-sm text-gray-600", children: "Plan actuel" }), _jsx("p", { className: "text-2xl font-bold text-gray-900", children: "Pro" }), _jsx(Badge, { className: "w-fit", children: "Actif" })] }) }) }), _jsx(Card, { children: _jsx(CardContent, { className: "pt-6", children: _jsxs("div", { className: "space-y-2", children: [_jsx("p", { className: "text-sm text-gray-600", children: "Montant mensuel" }), _jsx("p", { className: "text-2xl font-bold text-gray-900", children: "\u20AC299" }), _jsx("p", { className: "text-xs text-gray-600", children: "Factur\u00E9 mensuellement" })] }) }) }), _jsx(Card, { children: _jsx(CardContent, { className: "pt-6", children: _jsxs("div", { className: "space-y-2", children: [_jsx("p", { className: "text-sm text-gray-600", children: "Prochaine facturation" }), _jsx("p", { className: "text-2xl font-bold text-gray-900", children: "01 Mai" }), _jsx("p", { className: "text-xs text-gray-600", children: "2026" })] }) }) })] }), _jsxs(Card, { children: [_jsxs(CardHeader, { children: [_jsx(CardTitle, { children: "M\u00E9triques d'utilisation" }), _jsx(CardDescription, { children: "Utilisation actuelle des ressources" })] }), _jsx(CardContent, { children: _jsxs("div", { className: "grid gap-4 sm:grid-cols-3", children: [_jsxs("div", { className: "rounded-lg border border-gray-200 p-4", children: [_jsx("p", { className: "text-sm text-gray-600", children: "V\u00E9hicules suivis" }), _jsx("p", { className: "text-2xl font-bold text-gray-900 mt-2", children: "847 / 1000" }), _jsx("div", { className: "w-full bg-gray-200 rounded-full h-2 mt-3", children: _jsx("div", { className: "bg-blue-600 h-2 rounded-full", style: { width: '84.7%' } }) })] }), _jsxs("div", { className: "rounded-lg border border-gray-200 p-4", children: [_jsx("p", { className: "text-sm text-gray-600", children: "Appels API (mois)" }), _jsx("p", { className: "text-2xl font-bold text-gray-900 mt-2", children: "2.4M / 5M" }), _jsx("div", { className: "w-full bg-gray-200 rounded-full h-2 mt-3", children: _jsx("div", { className: "bg-blue-600 h-2 rounded-full", style: { width: '48%' } }) })] }), _jsxs("div", { className: "rounded-lg border border-gray-200 p-4", children: [_jsx("p", { className: "text-sm text-gray-600", children: "Stockage utilis\u00E9" }), _jsx("p", { className: "text-2xl font-bold text-gray-900 mt-2", children: "45.2 GB / 100 GB" }), _jsx("div", { className: "w-full bg-gray-200 rounded-full h-2 mt-3", children: _jsx("div", { className: "bg-blue-600 h-2 rounded-full", style: { width: '45.2%' } }) })] })] }) })] }), _jsxs(Card, { children: [_jsxs(CardHeader, { children: [_jsx(CardTitle, { children: "Modifier le plan" }), _jsx(CardDescription, { children: "Changer le plan d'abonnement" })] }), _jsx(CardContent, { children: _jsxs("div", { className: "grid gap-4 sm:grid-cols-3", children: [_jsxs("div", { className: "rounded-lg border border-gray-200 p-4", children: [_jsx("p", { className: "font-medium text-gray-900", children: "Starter" }), _jsx("p", { className: "text-2xl font-bold text-gray-900 mt-2", children: "\u20AC99" }), _jsx("p", { className: "text-xs text-gray-600 mt-1", children: "/mois" }), _jsx(Button, { variant: "outline", className: "w-full mt-4", children: "R\u00E9trograder" })] }), _jsxs("div", { className: "rounded-lg border-2 border-blue-600 p-4 bg-blue-50", children: [_jsx("p", { className: "font-medium text-gray-900", children: "Pro" }), _jsx("p", { className: "text-2xl font-bold text-blue-600 mt-2", children: "\u20AC299" }), _jsx("p", { className: "text-xs text-gray-600 mt-1", children: "/mois" }), _jsx(Badge, { className: "w-fit mt-4", children: "Plan actuel" })] }), _jsxs("div", { className: "rounded-lg border border-gray-200 p-4", children: [_jsx("p", { className: "font-medium text-gray-900", children: "Enterprise" }), _jsx("p", { className: "text-2xl font-bold text-gray-900 mt-2", children: "\u20AC1299" }), _jsx("p", { className: "text-xs text-gray-600 mt-1", children: "/mois" }), _jsx(Button, { className: "w-full mt-4", children: "Passer \u00E0 Enterprise" })] })] }) })] }), _jsxs(Card, { children: [_jsxs(CardHeader, { children: [_jsx(CardTitle, { children: "Historique de facturation" }), _jsx(CardDescription, { children: "Les 12 derni\u00E8res factures" }), _jsxs(Button, { variant: "link", size: "sm", onClick: fetchBillingData, className: "mt-2 gap-1", children: [_jsx(RefreshCw, { className: "h-3 w-3" }), "Actualiser"] })] }), _jsx(CardContent, { children: _jsx("div", { className: "overflow-x-auto", children: _jsxs("table", { className: "w-full text-sm", children: [_jsx("thead", { children: _jsxs("tr", { className: "border-b border-gray-200", children: [_jsx("th", { className: "text-left py-3 px-4 font-medium text-gray-700", children: "Date" }), _jsx("th", { className: "text-left py-3 px-4 font-medium text-gray-700", children: "Description" }), _jsx("th", { className: "text-left py-3 px-4 font-medium text-gray-700", children: "Montant" }), _jsx("th", { className: "text-left py-3 px-4 font-medium text-gray-700", children: "\u00C9tat" })] }) }), _jsx("tbody", { children: billingData.map(record => (_jsxs("tr", { className: "border-b border-gray-100 hover:bg-gray-50", children: [_jsx("td", { className: "py-3 px-4", children: new Date(record.date).toLocaleDateString('fr-FR') }), _jsx("td", { className: "py-3 px-4", children: record.description }), _jsxs("td", { className: "py-3 px-4 font-medium", children: ["\u20AC", record.amount] }), _jsx("td", { className: "py-3 px-4", children: _jsx(Badge, { variant: record.status === 'payée'
                                                                    ? 'default'
                                                                    : record.status === 'en attente'
                                                                        ? 'secondary'
                                                                        : 'destructive', children: record.status === 'payée' ? 'Payée' : record.status === 'en attente' ? 'En attente' : 'Échouée' }) })] }, record.id))) })] }) }) })] })] })), activeTab === 'whitelabel' && (_jsxs("div", { className: "space-y-6", children: [_jsxs("div", { children: [_jsx("label", { className: "block text-sm font-medium text-gray-700 mb-2", children: "S\u00E9lectionner une organisation" }), _jsx("select", { value: whitelabelOrg, onChange: e => setWhitelabelOrg(e.target.value), className: "w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500", children: organizations.map(org => (_jsx("option", { value: org.id, children: org.name }, org.id))) })] }), _jsxs(Card, { children: [_jsx(CardHeader, { children: _jsxs(CardTitle, { className: "flex items-center gap-2", children: [_jsx(Palette, { className: "h-5 w-5" }), "Activation White Label"] }) }), _jsx(CardContent, { children: _jsxs("div", { className: "flex items-center gap-4", children: [_jsx("input", { type: "checkbox", defaultChecked: true, className: "h-4 w-4 rounded border-gray-300" }), _jsx("label", { className: "text-sm text-gray-700", children: "Activer la personnalisation White Label pour cette organisation" })] }) })] }), _jsxs(Card, { children: [_jsxs(CardHeader, { children: [_jsx(CardTitle, { children: "Options de marque" }), _jsx(CardDescription, { children: "Personnalisez l'apparence de la plateforme" })] }), _jsx(CardContent, { children: _jsxs("div", { className: "space-y-6", children: [_jsxs("div", { children: [_jsx("p", { className: "text-sm font-medium text-gray-700 mb-2", children: "Logo personnalis\u00E9" }), _jsxs("div", { className: "border-2 border-dashed border-gray-300 rounded-lg p-8 text-center hover:border-gray-400 transition-colors", children: [_jsx(Upload, { className: "h-8 w-8 text-gray-400 mx-auto mb-2" }), _jsx("p", { className: "text-sm text-gray-600", children: "Cliquez pour t\u00E9l\u00E9charger votre logo" }), _jsx("p", { className: "text-xs text-gray-500 mt-1", children: "PNG, JPG ou SVG - Max 5 MB" })] })] }), _jsxs("div", { children: [_jsx("p", { className: "text-sm font-medium text-gray-700 mb-2", children: "Couleurs personnalis\u00E9es" }), _jsxs("div", { className: "grid gap-4 sm:grid-cols-2", children: [_jsxs("div", { children: [_jsx("label", { className: "block text-sm text-gray-600 mb-2", children: "Couleur primaire" }), _jsx("input", { type: "color", defaultValue: "#3b82f6", className: "h-10 w-20 rounded border border-gray-300 cursor-pointer" })] }), _jsxs("div", { children: [_jsx("label", { className: "block text-sm text-gray-600 mb-2", children: "Couleur secondaire" }), _jsx("input", { type: "color", defaultValue: "#8b5cf6", className: "h-10 w-20 rounded border border-gray-300 cursor-pointer" })] })] })] }), _jsxs("div", { children: [_jsx("label", { className: "block text-sm font-medium text-gray-700 mb-2", children: "Domaine personnalis\u00E9" }), _jsx(Input, { type: "text", placeholder: "app.votresociete.com", defaultValue: "trackzone.techcorp.com", className: "w-full" }), _jsx("p", { className: "text-xs text-gray-600 mt-2", children: "Configurez les enregistrements DNS pour activer le domaine" })] }), _jsxs("div", { children: [_jsx("label", { className: "block text-sm font-medium text-gray-700 mb-2", children: "Texte du pied de page" }), _jsx(Input, { type: "text", placeholder: "\u00A9 2026 Votre entreprise. Tous droits r\u00E9serv\u00E9s.", defaultValue: "Propuls\u00E9 par TrackZone", className: "w-full" })] }), _jsx("div", { children: _jsxs("label", { className: "flex items-center gap-2", children: [_jsx("input", { type: "checkbox", defaultChecked: true, className: "rounded" }), _jsx("span", { className: "text-sm text-gray-700", children: "Utiliser le logo dans les e-mails" })] }) }), _jsxs("div", { className: "flex gap-2 pt-4", children: [_jsxs(Button, { className: "gap-2", children: [_jsx(Zap, { className: "h-4 w-4" }), "Enregistrer les modifications"] }), _jsx(Button, { variant: "outline", children: "Aper\u00E7u" })] })] }) })] }), _jsxs(Card, { children: [_jsx(CardHeader, { children: _jsx(CardTitle, { children: "Aper\u00E7u" }) }), _jsx(CardContent, { children: _jsxs("div", { className: "border border-gray-300 rounded-lg p-6 bg-gradient-to-br from-blue-50 to-purple-50", children: [_jsx("div", { className: "w-24 h-24 rounded-lg bg-white border-2 border-blue-600 flex items-center justify-center mb-4", children: _jsx("span", { className: "text-xs text-gray-500", children: "Logo" }) }), _jsx("p", { className: "text-sm font-medium text-gray-700 mb-4", children: "Aper\u00E7u de votre marque personnalis\u00E9e" }), _jsx("p", { className: "text-xs text-gray-600", children: "\u00A9 2026 Votre entreprise. Tous droits r\u00E9serv\u00E9s." })] }) })] })] })), activeTab === 'echoes' && (_jsxs("div", { className: "space-y-6", children: [_jsxs("div", { className: "grid gap-4 sm:grid-cols-3", children: [_jsx(Card, { children: _jsx(CardContent, { className: "pt-6", children: _jsxs("div", { className: "space-y-2", children: [_jsxs("div", { className: "flex items-center gap-2", children: [_jsx(Circle, { className: "h-3 w-3 text-green-600 fill-green-600" }), _jsx("p", { className: "text-sm text-gray-600", children: "En ligne" })] }), _jsx("p", { className: "text-2xl font-bold text-gray-900", children: "2" })] }) }) }), _jsx(Card, { children: _jsx(CardContent, { className: "pt-6", children: _jsxs("div", { className: "space-y-2", children: [_jsxs("div", { className: "flex items-center gap-2", children: [_jsx(Circle, { className: "h-3 w-3 text-gray-400 fill-gray-400" }), _jsx("p", { className: "text-sm text-gray-600", children: "Hors ligne" })] }), _jsx("p", { className: "text-2xl font-bold text-gray-900", children: "1" })] }) }) }), _jsx(Card, { children: _jsx(CardContent, { className: "pt-6", children: _jsxs("div", { className: "space-y-2", children: [_jsxs("div", { className: "flex items-center gap-2", children: [_jsx(Circle, { className: "h-3 w-3 text-yellow-600 fill-yellow-600" }), _jsx("p", { className: "text-sm text-gray-600", children: "Maintenance" })] }), _jsx("p", { className: "text-2xl font-bold text-gray-900", children: "1" })] }) }) })] }), _jsx("div", { className: "flex gap-2", children: ['all', 'online', 'offline', 'maintenance'].map(status => (_jsx(Button, { variant: trackerStatusFilter === status ? 'default' : 'outline', size: "sm", onClick: () => setTrackerStatusFilter(status), children: status === 'all' ? 'Tous' : status === 'online' ? 'En ligne' : status === 'offline' ? 'Hors ligne' : 'Maintenance' }, status))) }), _jsxs(Card, { children: [_jsxs(CardHeader, { children: [_jsxs(CardTitle, { className: "flex items-center gap-2", children: [_jsx(Radio, { className: "h-5 w-5" }), "Trackers Echoes"] }), _jsx(CardDescription, { children: "G\u00E9rer les trackers et envoyer des commandes" })] }), _jsx(CardContent, { children: _jsx("div", { className: "space-y-2", children: mockTrackers
                                        .filter(t => trackerStatusFilter === 'all' || t.status === trackerStatusFilter)
                                        .map(tracker => (_jsxs("div", { className: "flex items-center justify-between rounded-lg border border-gray-200 p-4 hover:border-gray-300 transition-colors", children: [_jsxs("div", { className: "flex-1", children: [_jsxs("div", { className: "flex items-center gap-2", children: [_jsx(Circle, { className: `h-3 w-3 ${tracker.status === 'online'
                                                                    ? 'text-green-600 fill-green-600'
                                                                    : tracker.status === 'offline'
                                                                        ? 'text-gray-400 fill-gray-400'
                                                                        : 'text-yellow-600 fill-yellow-600'}` }), _jsx("p", { className: "font-medium text-gray-900", children: tracker.name })] }), _jsxs("div", { className: "flex items-center gap-4 mt-2 text-sm text-gray-600", children: [_jsx("span", { children: tracker.organizationName }), _jsxs("span", { children: ["Dernier contact:", ' ', _jsx("span", { className: "font-medium", children: formatTimeAgo(new Date(tracker.lastCommunication)) })] })] })] }), _jsxs("div", { className: "flex items-center gap-2", children: [_jsx(Badge, { variant: tracker.status === 'online'
                                                            ? 'default'
                                                            : tracker.status === 'offline'
                                                                ? 'secondary'
                                                                : 'outline', className: "capitalize", children: tracker.status === 'online' ? 'En ligne' : tracker.status === 'offline' ? 'Hors ligne' : 'Maintenance' }), _jsxs(Button, { variant: "outline", size: "sm", className: "gap-1 text-xs", children: [_jsx(Zap, { className: "h-3 w-3" }), "Commandes"] })] })] }, tracker.id))) }) })] }), _jsxs(Card, { children: [_jsxs(CardHeader, { children: [_jsx(CardTitle, { children: "Commandes disponibles" }), _jsx(CardDescription, { children: "Envoyer des commandes aux trackers Echoes" })] }), _jsx(CardContent, { children: _jsxs("div", { className: "grid gap-4 sm:grid-cols-3", children: [_jsxs(Button, { variant: "outline", className: "gap-2 h-auto flex-col justify-start p-4", children: [_jsx(Radio, { className: "h-5 w-5 text-blue-600" }), _jsx("span", { className: "text-sm font-medium", children: "Localiser" }), _jsx("span", { className: "text-xs text-gray-600", children: "Position GPS imm\u00E9diate" })] }), _jsxs(Button, { variant: "outline", className: "gap-2 h-auto flex-col justify-start p-4", children: [_jsx(Power, { className: "h-5 w-5 text-red-600" }), _jsx("span", { className: "text-sm font-medium", children: "Red\u00E9marrer" }), _jsx("span", { className: "text-xs text-gray-600", children: "Red\u00E9marrage du tracker" })] }), _jsxs(Button, { variant: "outline", className: "gap-2 h-auto flex-col justify-start p-4", children: [_jsx(AlertOctagon, { className: "h-5 w-5 text-yellow-600" }), _jsx("span", { className: "text-sm font-medium", children: "Diagnostic" }), _jsx("span", { className: "text-xs text-gray-600", children: "\u00C9tat et sant\u00E9 du tracker" })] })] }) })] }), _jsxs(Card, { children: [_jsx(CardHeader, { children: _jsxs(CardTitle, { className: "flex items-center gap-2", children: [_jsx(Wifi, { className: "h-5 w-5" }), "\u00C9tat de la connexion"] }) }), _jsx(CardContent, { children: _jsxs("div", { className: "grid gap-4 sm:grid-cols-2", children: [_jsxs("div", { className: "rounded-lg border border-gray-200 p-4", children: [_jsx("p", { className: "text-sm text-gray-600 mb-2", children: "Serveur Echoes" }), _jsxs("div", { className: "flex items-center gap-2", children: [_jsx(Circle, { className: "h-3 w-3 text-green-600 fill-green-600" }), _jsx("p", { className: "font-medium text-green-600", children: "Connect\u00E9" })] }), _jsx("p", { className: "text-xs text-gray-600 mt-2", children: "Latence: 42ms" })] }), _jsxs("div", { className: "rounded-lg border border-gray-200 p-4", children: [_jsx("p", { className: "text-sm text-gray-600 mb-2", children: "Synchronisation" }), _jsx("p", { className: "font-medium text-gray-900", children: "\u00C0 jour" }), _jsx("p", { className: "text-xs text-gray-600 mt-2", children: "Derni\u00E8re sync: \u00E0 l'instant" })] })] }) })] })] })), showOrgModal && (_jsx("div", { className: "fixed inset-0 z-50 flex items-center justify-center bg-black/50", children: _jsxs(Card, { className: "w-full max-w-md", children: [_jsxs(CardHeader, { children: [_jsx(CardTitle, { children: editingOrg ? 'Éditer organisation' : 'Créer une organisation' }), _jsx(CardDescription, { children: editingOrg ? 'Modifiez les détails de l\'organisation' : 'Créez une nouvelle organisation' })] }), _jsx(CardContent, { children: _jsxs("div", { className: "space-y-4", children: [_jsxs("div", { children: [_jsx("label", { className: "block text-sm font-medium text-gray-900 mb-2", children: "Nom" }), _jsx(Input, { value: orgFormData.name, onChange: e => setOrgFormData({ ...orgFormData, name: e.target.value }), placeholder: "Nom de l'organisation" })] }), _jsxs("div", { children: [_jsx("label", { className: "block text-sm font-medium text-gray-900 mb-2", children: "Plan" }), _jsxs("select", { value: orgFormData.plan, onChange: e => setOrgFormData({ ...orgFormData, plan: e.target.value }), className: "w-full px-3 py-2 border border-gray-300 rounded-lg text-sm", children: [_jsx("option", { value: "Starter", children: "Starter" }), _jsx("option", { value: "Pro", children: "Pro" }), _jsx("option", { value: "Enterprise", children: "Enterprise" })] })] }), _jsxs("div", { children: [_jsx("label", { className: "block text-sm font-medium text-gray-900 mb-2", children: "Param\u00E8tres" }), _jsx(Input, { value: orgFormData.settings, onChange: e => setOrgFormData({ ...orgFormData, settings: e.target.value }), placeholder: "Param\u00E8tres additionnels (JSON)" })] }), _jsxs("div", { className: "flex gap-2 justify-end pt-4", children: [_jsx(Button, { variant: "outline", onClick: closeOrgModal, children: "Annuler" }), _jsx(Button, { onClick: saveOrganization, children: editingOrg ? 'Mettre à jour' : 'Créer' })] })] }) })] }) })), showUserModal && (_jsx("div", { className: "fixed inset-0 z-50 flex items-center justify-center bg-black/50", children: _jsxs(Card, { className: "w-full max-w-md", children: [_jsxs(CardHeader, { children: [_jsx(CardTitle, { children: editingUser ? 'Éditer utilisateur' : 'Créer un utilisateur' }), _jsx(CardDescription, { children: editingUser ? 'Modifiez les détails de l\'utilisateur' : 'Créez un nouvel utilisateur' })] }), _jsx(CardContent, { children: _jsxs("div", { className: "space-y-4", children: [_jsxs("div", { children: [_jsx("label", { className: "block text-sm font-medium text-gray-900 mb-2", children: "Nom" }), _jsx(Input, { value: userFormData.name, onChange: e => setUserFormData({ ...userFormData, name: e.target.value }), placeholder: "Nom complet" })] }), _jsxs("div", { children: [_jsx("label", { className: "block text-sm font-medium text-gray-900 mb-2", children: "Email" }), _jsx(Input, { value: userFormData.email, onChange: e => setUserFormData({ ...userFormData, email: e.target.value }), placeholder: "email@example.com", type: "email" })] }), _jsxs("div", { children: [_jsx("label", { className: "block text-sm font-medium text-gray-900 mb-2", children: "R\u00F4le" }), _jsxs("select", { value: userFormData.role, onChange: e => setUserFormData({ ...userFormData, role: e.target.value }), className: "w-full px-3 py-2 border border-gray-300 rounded-lg text-sm", children: [_jsx("option", { value: "super_admin", children: "Super Admin" }), _jsx("option", { value: "admin", children: "Admin" }), _jsx("option", { value: "manager", children: "Manager" }), _jsx("option", { value: "operator", children: "Op\u00E9rateur" }), _jsx("option", { value: "driver", children: "Conducteur" })] })] }), _jsxs("div", { children: [_jsx("label", { className: "block text-sm font-medium text-gray-900 mb-2", children: "Organisation" }), _jsxs("select", { value: userFormData.organizationId, onChange: e => setUserFormData({ ...userFormData, organizationId: e.target.value }), className: "w-full px-3 py-2 border border-gray-300 rounded-lg text-sm", children: [_jsx("option", { value: "", children: "-- S\u00E9lectionner une organisation --" }), organizations.map(org => (_jsx("option", { value: org.id, children: org.name }, org.id)))] })] }), _jsxs("div", { className: "flex gap-2 justify-end pt-4", children: [_jsx(Button, { variant: "outline", onClick: closeUserModal, children: "Annuler" }), _jsx(Button, { onClick: saveUser, children: editingUser ? 'Mettre à jour' : 'Créer' })] })] }) })] }) }))] }));
}
