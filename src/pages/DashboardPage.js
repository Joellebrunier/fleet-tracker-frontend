...
export default function DashboardPage() {
    ...
    return (_jsxs("div", { className: "space-y-6 bg-[#0A0A0F]", children: [_jsx(KeyboardShortcutsModal, {}), _jsxs("div", { className: "flex items-center justify-between", children: [_jsxs("div", { children: [_jsx("h1", { className: "text-2xl font-bold font-syne text-[#F0F0F5]", children: "Tableau de bord" }), _jsxs("p", { className: "mt-1 text-sm text-[#6B6B80]", children: ["Vue d'ensemble de votre flotte \u2014 ", stats.total, " v\u00E9hicules, ", stats.withGps, " avec GPS actif"] })] }), _jsxs("div", { className: "flex gap-2", children: [_jsxs(Button, { variant: "outline", size: "sm", className: "gap-2 border-[#1F1F2E] bg-[#12121A] text-[#F0F0F5] hover:bg-[#1A1A25]", title: "Appuyez sur ? pour les raccourcis", children: [_jsx(HelpCircle, { size: 16 }), _jsx("span", { children: "Aide" })] }), _jsxs(Button, { variant: "outline", size: "sm", onClick: () => setShowWidgetConfig(!showWidgetConfig), className: "gap-2 border-[#1F1F2E] bg-[#12121A] text-[#F0F0F5] hover:bg-[#1A1A25]", children: [_jsx(Settings, { size: 16 }), _jsx("span", { children: "Personnaliser" })] })] })] }), showWidgetConfig && (_jsxs("div", { className: "tz-card bg-[#12121A] border border-[#1F1F2E] rounded-[var(--tz-radius)]", children: [_jsx("div", { className: "pb-4 px-6 pt-6 border-b border-[#1F1F2E]", children: _jsxs("div", { className: "flex items-center justify-between", children: [_jsxs("div", { children: [_jsx("h3", { className: "font-syne text-base font-bold text-[#F0F0F5]", children: "Personnaliser les widgets" }), _jsx("p", { className: "text-sm mt-1 text-[#6B6B80]", children: "G\u00E9rez la visibilit\u00E9, la taille et l'ordre des widgets de votre tableau de bord" })] }), _jsxs(Button, { variant: "outline", size: "sm", onClick: resetWidgetConfig, className: "gap-2 text-[#FFB547] border-[#FFB547]/30 bg-[#FFB547]/10 hover:bg-[#FFB547]/20", children: [_jsx(RotateCcw, { size: 14 }), _jsx("span", { children: "R\u00E9initialiser" })] })] }) }), _jsx("div", { className: "px-6 py-6", children: _jsx("div", { className: "space-y-3", children: widgetOrder.map((id) => (_jsxs("div", { className: "flex items-center gap-3 p-3 bg-[#1A1A25] rounded-[var(--tz-radius-sm)] border border-[#1F1F2E] hover:border-[#2A2A3D] transition-colors", children: [_jsx("label", { className: "flex items-center gap-2 cursor-pointer", children: _jsx("input", { type: "checkbox", checked: widgetConfig[id].visible, onChange: () => toggleWidgetVisibility(id), className: "w-4 h-4 rounded cursor-pointer accent-[#00E5CC]" }) }), _jsx("div", { className: "flex-1", children: _jsx("span", { className: `text-sm font-medium ${widgetConfig[id].visible ? 'text-[#F0F0F5]' : 'text-[#6B6B80]'}`, children: widgetLabels[id] }) }), _jsx("div", { className: "flex gap-1 bg-[#12121A] rounded-[var(--tz-radius-sm)] p-1", children: ['compact', 'normal', 'expanded'].map((size) => (_jsx("button", { onClick: () => setWidgetSize(id, size), title: size === 'compact' ? 'Compact' : size === 'normal' ? 'Normal' : 'Large', className: `px-2 py-1 text-xs rounded transition-colors ${widgetConfig[id].size === size
                    ...
                    : widgetConfig['daily-summary'].size === 'normal'
                        ...
                        : 'md:col-span-1 lg:col-span-1'}`, children: _jsxs("div", { className: "relative group", children: [_jsx("div", { className: "absolute -left-8 top-0 opacity-0 group-hover:opacity-100 transition-opacity", children: _jsx(GripHorizontal, { size: 16, className: "text-[#6B6B80]" }) }), _jsxs("div", { className: "tz-card bg-[#12121A] border border-[#1F1F2E] rounded-[var(--tz-radius)]", children: [_jsxs("div", { className: "px-6 py-4 border-b border-[#1F1F2E]", children: [_jsx("h3", { className: "font-syne text-base font-bold text-[#F0F0F5]", children: "R\u00E9sum\u00E9 du jour" }), _jsx("p", { className: "text-xs text-[#6B6B80] mt-1", children: "M\u00E9triques cl\u00E9s d'aujourd'hui" })] }), _jsx("div", { className: "px-6 py-4", children: _jsxs("div", { className: "space-y-4", children: [_jsxs("div", { className: "flex items-center justify-between p-3 rounded-[var(--tz-radius-sm)] bg-[rgba(59,130,246,0.08)] border border-[rgba(59,130,246,0.15)]", children: [_jsxs("div", { className: "flex items-center gap-3", children: [_jsx(Route, { className: "text-[#3B82F6]", size: 20 }), _jsxs("div", { children: [_jsx("p", { className: "text-xs font-medium text-[#6B6B80]", children: "Kilom\u00E8tres parcourus" }), _jsxs("p", { className: "text-lg font-bold font-mono text-[#F0F0F5] mt-0.5", children: [dailySummary.totalKm.toLocaleString(), " km"] })] })] }), _jsxs("div", { className: `flex items-center gap-1 text-xs font-semibold px-2 py-1 rounded ${dailySummary.comparisons.km >= 0
                                                            ? 'bg-[rgba(34,197,94,0.2)] text-[#22C55E]'
                                                            : 'bg-[rgba(255,77,106,0.2)] text-[#FF4D6A]'}`, children: [dailySummary.comparisons.km >= 0 ? (_jsx(TrendingUp, { size: 14 })) : (_jsx(TrendingDown, { size: 14 })), dailySummary.comparisons.km >= 0 ? '+' : '', dailySummary.comparisons.km.toFixed(1), "%"] })] }), _jsxs("div", { className: "flex items-center justify-between p-3 rounded-[var(--tz-radius-sm)] bg-[rgba(168,85,247,0.08)] border border-[rgba(168,85,247,0.15)]", children: [_jsxs("div", { className: "flex items-center gap-3", children: [_jsx(Navigation, { className: "text-[#A855F7]", size: 20 }), _jsxs("div", { children: [_jsx("p", { className: "text-xs font-medium text-[#6B6B80]", children: "Nombre de trajets" }), _jsx("p", { className: "text-lg font-bold font-mono text-[#F0F0F5] mt-0.5", children: dailySummary.trips })] })] }), _jsxs("div", { className: `flex items-center gap-1 text-xs font-semibold px-2 py-1 rounded ${dailySummary.comparisons.trips >= 0
                                                            ? 'bg-[rgba(34,197,94,0.2)] text-[#22C55E]'
                                                            : 'bg-[rgba(255,77,106,0.2)] text-[#FF4D6A]'}`, children: [dailySummary.comparisons.trips >= 0 ? (_jsx(TrendingUp, { size: 14 })) : (_jsx(TrendingDown, { size: 14 })), dailySummary.comparisons.trips >= 0 ? '+' : '', dailySummary.comparisons.trips.toFixed(1), "%"] })] }), _jsx("div", { className: "flex items-center justify-between p-3 rounded-[var(--tz-radius-sm)] bg-[rgba(255,181,71,0.08)] border border-[rgba(255,181,71,0.15)]", children: _jsxs("div", { className: "flex items-center gap-3", children: [_jsx(Clock, { className: "text-[#FFB547]", size: 20 }), _jsxs("div", { children: [_jsx("p", { className: "text-xs font-medium text-[#6B6B80]", children: "Temps de conduite moyen" }), _jsxs("p", { className: "text-lg font-bold font-mono text-[#F0F0F5] mt-0.5", children: [Math.floor(dailySummary.avgDriveTime / 60), "h ", dailySummary.avgDriveTime % 60, "m"] })] })] }) }), _jsxs("div", { className: "flex items-center justify-between p-3 rounded-[var(--tz-radius-sm)] bg-[rgba(255,77,106,0.08)] border border-[rgba(255,77,106,0.15)]", children: [_jsxs("div", { className: "flex items-center gap-3", children: [_jsx(AlertCircle, { className: "text-[#FF4D6A]", size: 20 }), _jsxs("div", { children: [_jsx("p", { className: "text-xs font-medium text-[#6B6B80]", children: "Alertes du jour" }), _jsx("p", { className: "text-lg font-bold font-mono text-[#F0F0F5] mt-0.5", children: dailySummary.todayAlerts })] })] }), _jsxs("div", { className: `flex items-center gap-1 text-xs font-semibold px-2 py-1 rounded ${dailySummary.comparisons.alerts <= 0
                                                            ? 'bg-[rgba(34,197,94,0.2)] text-[#22C55E]'
                                                            : 'bg-[rgba(255,77,106,0.2)] text-[#FF4D6A]'}`, children: [dailySummary.comparisons.alerts <= 0 ? (_jsx(TrendingDown, { size: 14 })) : (_jsx(TrendingUp, { size: 14 })), dailySummary.comparisons.alerts >= 0 ? '+' : '', dailySummary.comparisons.alerts.toFixed(1), "%"] })] }), _jsx("div", { className: "flex items-center justify-between p-3 rounded-[var(--tz-radius-sm)] bg-[rgba(0,229,204,0.08)] border border-[rgba(0,229,204,0.15)]", children: _jsxs("div", { className: "flex items-center gap-3", children: [_jsx(Shield, { className: "text-[#00E5CC]", size: 20 }), _jsxs("div", { children: [_jsx("p", { className: "text-xs font-medium text-[#6B6B80]", children: "G\u00E9ocl\u00F4tures viol\u00E9es" }), _jsx("p", { className: "text-lg font-bold font-mono text-[#F0F0F5] mt-0.5", children: dailySummary.geofenceViolations })] })] }) })] }) })] })] }) })), widgetConfig['activity-feed'].visible && (_jsx("div", { className: `${widgetConfig['activity-feed'].size === 'expanded'
                    ? 'md:col-span-2 lg:col-span-4'
                    : widgetConfig['activity-feed'].size === 'normal'
                        ? 'md:col-span-2 lg:col-span-2'
                        : 'md:col-span-1 lg:col-span-1'}`, children: _jsxs("div", { className: "relative group", children: [_jsx("div", { className: "absolute -left-8 top-0 opacity-0 group-hover:opacity-100 transition-opacity", children: _jsx(GripHorizontal, { size: 16, className: "text-[#6B6B80]" }) }), _jsxs("div", { className: "tz-card bg-[#12121A] border border-[#1F1F2E] rounded-[var(--tz-radius)]", children: [_jsx("div", { className: "px-6 py-4 border-b border-[#1F1F2E]", children: _jsxs("div", { className: "flex items-center justify-between", children: [_jsxs("div", { children: [_jsx("h3", { className: "font-syne text-base font-bold text-[#F0F0F5]", children: "Fil d'activit\u00E9 r\u00E9cente" }), _jsx("p", { className: "text-xs text-[#6B6B80] mt-1", children: "\u00C9v\u00E9nements de la derni\u00E8re heure" })] }), _jsx(Button, { variant: "ghost", size: "sm", className: "text-xs text-[#00E5CC] hover:bg-[#1A1A25]", onClick: () => navigate('/activity'), children: "Tout voir" })] }) }), _jsx("div", { className: "px-6 py-4", children: _jsx("div", { className: "space-y-3 max-h-96 overflow-y-auto", children: activityFeedEvents.slice(0, 12).map((event) => {
                                            ...
                                            return (_jsxs("div", { className: "flex gap-3 p-2.5 rounded-[var(--tz-radius-sm)] border border-[#1F1F2E] hover:bg-[#1A1A25] transition-colors", children: [_jsx("div", { className: `rounded-[var(--tz-radius-sm)] p-2 flex-shrink-0 ${iconColorMap[event.type]}`, children: _jsx(IconComponent, { size: 16 }) }), _jsxs("div", { className: "flex-1 min-w-0", children: [_jsx("p", { className: "text-sm font-medium text-[#F0F0F5]", children: event.title }), _jsx("p", { className: "text-xs text-[#6B6B80] mt-0.5", children: event.description }), _jsxs("div", { className: "flex items-center gap-2 mt-1", children: [_jsx("span", { className: "text-xs font-medium text-[#44445A]", children: event.vehicleName }), _jsx("span", { className: "text-xs text-[#44445A]", children: "\u00B7" }), _jsx("span", { className: "text-xs text-[#44445A]", children: timeAgo })] })] })] }, event.id));
                            ...
                            : widgetConfig['hourly-activity'].size === 'normal'
                                ? 'md:col-span-2 lg:col-span-2'
                                : 'md:col-span-1 lg:col-span-1'}`, children: _jsxs("div", { className: "relative group", children: [_jsx("div", { className: "absolute -left-8 top-0 opacity-0 group-hover:opacity-100 transition-opacity", children: _jsx(GripHorizontal, { size: 16, className: "text-[#6B6B80]" }) }), _jsxs("div", { className: "tz-card bg-[#12121A] border border-[#1F1F2E] rounded-[var(--tz-radius)]", children: [_jsxs("div", { className: "px-6 py-4 border-b border-[#1F1F2E]", children: [_jsx("h3", { className: "font-syne text-base font-bold text-[#F0F0F5]", children: "Activit\u00E9 horaire (24h)" }), _jsx("p", { className: "text-xs text-[#6B6B80] mt-1", children: "V\u00E9hicules en mouvement vs arr\u00EAt\u00E9s" })] }), _jsx("div", { className: "px-6 py-4", children: _jsx(ResponsiveContainer, { width: "100%", height: 300, children: _jsxs(AreaChart, { data: hourlyData, children: [_jsxs("defs", { children: [_jsxs("linearGradient", { id: "colorMoving", x1: "0", y1: "0", x2: "0", y2: "1", children: [_jsx("stop", { offset: "5%", stopColor: "#22c55e", stopOpacity: 0.8 }), _jsx("stop", { offset: "95%", stopColor: "#22c55e", stopOpacity: 0.1 })] }), _jsxs("linearGradient", { id: "colorStopped", x1: "0", y1: "0", x2: "0", y2: "1", children: [_jsx("stop", { offset: "5%", stopColor: "#FF4D6A", stopOpacity: 0.8 }), _jsx("stop", { offset: "95%", stopColor: "#FF4D6A", stopOpacity: 0.1 })] })] }), _jsx(CartesianGrid, { strokeDasharray: "3 3", stroke: "#2A2A3D" }), _jsx(XAxis, { dataKey: "hour", stroke: "#6B6B80", style: { fontSize: '12px' } }), _jsx(YAxis, { stroke: "#6B6B80", style: { fontSize: '12px' } }), _jsx(Tooltip, { contentStyle: {
                                                                backgroundColor: '#12121A',
                                                                border: '1px solid #1F1F2E',
                                                                borderRadius: '8px',
                                                                color: '#F0F0F5',
                                                            }, formatter: (value) => [value, ''] }), _jsx(Area, { type: "monotone", dataKey: "moving", stroke: "#22c55e", fillOpacity: 1, fill: "url(#colorMoving)", name: "En mouvement" }), _jsx(Area, { type: "monotone", dataKey: "stopped", stroke: "#FF4D6A", fillOpacity: 1, fill: "url(#colorStopped)", name: "Arr\u00EAt\u00E9s" })] }) }) })] })] }) })), widgetConfig['fleet-status'].visible && (_jsx("div", { className: `${widgetConfig['fleet-status'].size === 'expanded'
                            ? 'md:col-span-2 lg:col-span-4'
                            : widgetConfig['fleet-status'].size === 'normal'
                                ? 'md:col-span-2 lg:col-span-2'
                                : 'md:col-span-1 lg:col-span-1'}`, children: _jsxs("div", { className: "relative group", children: [_jsx("div", { className: "absolute -left-8 top-0 opacity-0 group-hover:opacity-100 transition-opacity", children: _jsx(GripHorizontal, { size: 16, className: "text-[#6B6B80]" }) }), _jsxs("div", { className: "tz-card bg-[#12121A] border border-[#1F1F2E] rounded-[var(--tz-radius)]", children: [_jsxs("div", { className: "px-6 py-4 border-b border-[#1F1F2E]", children: [_jsx("h3", { className: "font-syne text-base font-bold text-[#F0F0F5]", children: "\u00C9tat de la flotte" }), _jsx("p", { className: "text-xs text-[#6B6B80] mt-1", children: "Distribution par statut v\u00E9hicule" })] }), _jsx("div", { className: "px-6 py-4", children: _jsx(ResponsiveContainer, { width: "100%", height: 300, children: _jsxs(PieChart, { children: [_jsx(Pie, { data: vehicleStatusData, cx: "50%", cy: "50%", labelLine: false, label: ({ name, value }) => `${name}: ${value}`, outerRadius: 100, fill: "#8884d8", dataKey: "value", children: vehicleStatusData.map((entry, index) => (_jsx(Cell, { fill: entry.color }, `cell-${index}`))) }), _jsx(Tooltip, { formatter: (value) => `${value} véhicules`, contentStyle: {
                                                                backgroundColor: '#12121A',
                                                                border: '1px solid #1F1F2E',
                                                                borderRadius: '8px',
                                                                color: '#F0F0F5',
                            ...
                            : widgetConfig['alert-distribution'].size === 'normal'
                                ? 'md:col-span-2 lg:col-span-2'
                                : 'md:col-span-1 lg:col-span-1'}`, children: _jsxs("div", { className: "relative group", children: [_jsx("div", { className: "absolute -left-8 top-0 opacity-0 group-hover:opacity-100 transition-opacity", children: _jsx(GripHorizontal, { size: 16, className: "text-[#6B6B80]" }) }), _jsxs("div", { className: "tz-card bg-[#12121A] border border-[#1F1F2E] rounded-[var(--tz-radius)]", children: [_jsxs("div", { className: "px-6 py-4 border-b border-[#1F1F2E]", children: [_jsx("h3", { className: "font-syne text-base font-bold text-[#F0F0F5]", children: "Distribution des alertes" }), _jsx("p", { className: "text-xs text-[#6B6B80] mt-1", children: "Nombre d'alertes par type (derni\u00E8res 24h)" })] }), _jsx("div", { className: "px-6 py-4", children: _jsx(ResponsiveContainer, { width: "100%", height: 300, children: _jsxs(BarChart, { data: alertDistributionData, children: [_jsx(CartesianGrid, { strokeDasharray: "3 3", stroke: "#2A2A3D" }), _jsx(XAxis, { dataKey: "type", stroke: "#6B6B80", style: { fontSize: '12px' } }), _jsx(YAxis, { stroke: "#6B6B80", style: { fontSize: '12px' } }), _jsx(Tooltip, { contentStyle: {
                                                                backgroundColor: '#12121A',
                                                                border: '1px solid #1F1F2E',
                                                                borderRadius: '8px',
                                                                color: '#F0F0F5',
                                                            }, formatter: (value) => [`${value} alertes`, 'Nombre'] }), _jsx(Bar, { dataKey: "count", fill: "#00E5CC", radius: [8, 8, 0, 0] })] }) }) })] })] }) })), widgetConfig['quick-actions'].visible && (_jsx("div", { className: `${widgetConfig['quick-actions'].size === 'expanded'
                            ? 'md:col-span-2 lg:col-span-4'
                            : widgetConfig['quick-actions'].size === 'normal'
                                ? 'md:col-span-2 lg:col-span-2'
                                : 'md:col-span-1 lg:col-span-1'}`, children: _jsxs("div", { className: "relative group", children: [_jsx("div", { className: "absolute -left-8 top-0 opacity-0 group-hover:opacity-100 transition-opacity", children: _jsx(GripHorizontal, { size: 16, className: "text-[#6B6B80]" }) }), _jsxs("div", { className: "tz-card bg-[#12121A] border border-[#1F1F2E] rounded-[var(--tz-radius)]", children: [_jsxs("div", { className: "px-6 py-4 border-b border-[#1F1F2E]", children: [_jsx("h3", { className: "font-syne text-base font-bold text-[#F0F0F5]", children: "Actions rapides" }), _jsx("p", { className: "text-xs text-[#6B6B80] mt-1", children: "Acc\u00E8s direct aux fonctionnalit\u00E9s" })] }), _jsx("div", { className: "px-6 py-4", children: _jsxs("div", { className: "grid grid-cols-1 gap-2.5", children: [_jsxs(Button, { variant: "outline", className: "flex items-center justify-start gap-3 h-auto py-2.5 flex-row border-[#1F1F2E] bg-[#1A1A25] text-[#F0F0F5] hover:bg-[#1E1E2A]", onClick: () => navigate('/map'), children: [_jsx(MapPin, { size: 16 }), _jsx("span", { className: "text-xs", children: "Voir Carte" })] }), _jsxs(Button, { variant: "outline", className: "flex items-center justify-start gap-3 h-auto py-2.5 flex-row border-[#1F1F2E] bg-[#1A1A25] text-[#F0F0F5] hover:bg-[#1E1E2A]", onClick: () => navigate('/reports'), children: [_jsx(FileText, { size: 16 }), _jsx("span", { className: "text-xs", children: "Rapport" })] }), _jsxs(Button, { variant: "outline", className: "flex items-center justify-start gap-3 h-auto py-2.5 flex-row border-[#1F1F2E] bg-[#1A1A25] text-[#F0F0F5] hover:bg-[#1E1E2A]", onClick: () => navigate('/geofences'), children: [_jsx(Zap, { size: 16 }), _jsx("span", { className: "text-xs", children: "G\u00E9obarri\u00E8re" })] }), _jsxs(Button, { variant: "outline", className: "flex items-center justify-start gap-3 h-auto py-2.5 flex-row border-[#1F1F2E] bg-[#1A1A25] text-[#F0F0F5] hover:bg-[#1E1E2A]", onClick: () => navigate('/alerts/new'), children: [_jsx(Plus, { size: 16 }), _jsx("span", { className: "text-xs", children: "Alerte" })] })] }) })] })] }) }))] }), _jsxs("div", { className: "grid gap-6 auto-rows-max md:grid-cols-2 lg:grid-cols-4", children: [widgetConfig['alerts-feed'].visible && (_jsx("div", { className: `${widgetConfig['alerts-feed'].size === 'expanded'
                            ? 'md:col-span-2 lg:col-span-4'
                            : widgetConfig['alerts-feed'].size === 'normal'
                                ? 'md:col-span-2 lg:col-span-2'
                                : 'md:col-span-1 lg:col-span-1'}`, children: _jsxs("div", { className: "relative group", children: [_jsx("div", { className: "absolute -left-8 top-0 opacity-0 group-hover:opacity-100 transition-opacity", children: _jsx(GripHorizontal, { size: 16, className: "text-[#6B6B80]" }) }), _jsxs("div", { className: "tz-card bg-[#12121A] border border-[#1F1F2E] rounded-[var(--tz-radius)]", children: [_jsx("div", { className: "px-6 py-4 border-b border-[#1F1F2E]", children: _jsxs("div", { className: "flex items-center justify-between", children: [_jsxs("div", { children: [_jsx("h3", { className: "font-syne text-base font-bold text-[#F0F0F5]", children: "Fil d'activit\u00E9 r\u00E9cente" }), _jsx("p", { className: "text-xs text-[#6B6B80] mt-1", children: "Alertes et changements de statut" })] }), _jsx(Button, { variant: "ghost", size: "sm", className: "text-xs text-[#00E5CC] hover:bg-[#1A1A25]", onClick: () => navigate('/alerts'), children: "Voir tous" })] }) }), _jsx("div", { className: "px-6 py-4", children: alertsList.length > 0 ? (_jsx("div", { className: "space-y-3", children: alertsList.map((alert, idx) => (_jsxs("div", { className: "flex items-start gap-3 rounded-[var(--tz-radius-sm)] border border-[#1F1F2E] p-3 hover:bg-[#1A1A25] cursor-pointer transition-colors", children: [_jsx(AlertCircle, { size: 16, className: alert.severity === 'critical'
                                                                ? 'text-[#FF4D6A] flex-shrink-0 mt-0.5'
                                                                : 'text-[#FFB547] flex-shrink-0 mt-0.5' }), _jsxs("div", { className: "flex-1 min-w-0", children: [_jsxs("div", { className: "flex items-start justify-between gap-2", children: [_jsx("p", { className: "text-sm font-medium text-[#F0F0F5] truncate", children: alert.title }), _jsx(Badge, { variant: alert.severity === 'critical' ? 'destructive' : 'secondary', className: `flex-shrink-0 text-xs ${alert.severity === 'critical'
                                                                                ? 'bg-[#FF4D6A]/20 text-[#FF4D6A] border-[#FF4D6A]/30'
                                                                                : 'bg-[#FFB547]/20 text-[#FFB547] border-[#FFB547]/30'}`, children: alert.severity })] }), _jsx("p", { className: "text-xs text-[#6B6B80] line-clamp-2 mt-1", children: alert.message }), _jsx("p", { className: "text-xs text-[#44445A] mt-2", children: formatTimeAgo(alert.createdAt) })] })] }, idx))) })) : (_jsxs("div", { className: "flex flex-col items-center justify-center py-8 text-center", children: [_jsx(AlertCircle, { size: 24, className: "text-[#44445A] mb-2" }), _jsx("p", { className: "text-sm text-[#6B6B80]", children: "Aucune alerte r\u00E9cente" })] })) })] })] }) })), widgetConfig['status-summary'].visible && (_jsx("div", { className: `${widgetConfig['status-summary'].size === 'expanded'
                            ? 'md:col-span-2 lg:col-span-4'
                    ...
                    : widgetConfig['weekly-comparison'].size === 'normal'
                        ? 'lg:col-span-2'
                        : ''}`, children: _jsxs("div", { className: "relative group", children: [_jsx("div", { className: "absolute -left-8 top-0 opacity-0 group-hover:opacity-100 transition-opacity", children: _jsx(GripHorizontal, { size: 16, className: "text-[#6B6B80]" }) }), _jsxs("div", { className: "tz-card bg-[#12121A] border border-[#1F1F2E] rounded-[var(--tz-radius)]", children: [_jsxs("div", { className: "px-6 py-4 border-b border-[#1F1F2E]", children: [_jsx("h3", { className: "font-syne text-base font-bold text-[#F0F0F5]", children: "Comparaison hebdomadaire" }), _jsx("p", { className: "text-xs text-[#6B6B80] mt-1", children: "Cette semaine vs semaine derni\u00E8re" })] }), _jsx("div", { className: "px-6 py-4", children: _jsx(ResponsiveContainer, { width: "100%", height: 300, children: _jsxs(BarChart, { data: [
                                            ...
                                            ], children: [_jsx(CartesianGrid, { strokeDasharray: "3 3", stroke: "#2A2A3D" }), _jsx(XAxis, { dataKey: "name", stroke: "#6B6B80", style: { fontSize: '12px' } }), _jsx(YAxis, { stroke: "#6B6B80", style: { fontSize: '12px' } }), _jsx(Tooltip, { contentStyle: {
                                                        backgroundColor: '#12121A',
                                                        border: '1px solid #1F1F2E',
                                                        borderRadius: '8px',
                                                        color: '#F0F0F5',
                                                    } }), _jsx(Legend, { wrapperStyle: { color: '#6B6B80' } }), _jsx(Bar, { dataKey: "current", fill: "#00E5CC", radius: [8, 8, 0, 0], name: "Cette semaine" }), _jsx(Bar, { dataKey: "previous", fill: "#6B6B80", radius: [8, 8, 0, 0], name: "Semaine derni\u00E8re" })] }) }) })] })] }) })), widgetConfig.heatmap.visible && (_jsx("div", { className: `${widgetConfig.heatmap.size === 'expanded'
                    ? 'w-full'
                    : widgetConfig.heatmap.size === 'normal'
                        ? 'lg:col-span-2'
                        : ''}`, children: _jsxs("div", { className: "relative group", children: [_jsx("div", { className: "absolute -left-8 top-0 opacity-0 group-hover:opacity-100 transition-opacity z-10", children: _jsx(GripHorizontal, { size: 16, className: "text-[#6B6B80]" }) }), _jsxs("div", { className: "tz-card bg-[#12121A] border border-[#1F1F2E] rounded-[var(--tz-radius)]", children: [_jsxs("div", { className: "px-6 py-4 border-b border-[#1F1F2E]", children: [_jsx("h3", { className: "font-syne text-base font-bold text-[#F0F0F5]", children: "Zones d'activit\u00E9 (Carte thermique)" }), _jsx("p", { className: "text-xs text-[#6B6B80] mt-1", children: "Densit\u00E9 de v\u00E9hicules autour de Nice" })] }), _jsx("div", { className: "px-6 py-4", children: _jsxs("div", { className: "flex flex-col gap-4", children: [_jsxs("div", { className: "flex gap-6 text-xs", children: [_jsxs("div", { className: "flex items-center gap-2", children: [_jsx("div", { className: "w-4 h-4 rounded-full bg-red-500" }), _jsx("span", { className: "text-[#6B6B80]", children: "\u00C9lev\u00E9" })] }), _jsxs("div", { className: "flex items-center gap-2", children: [_jsx("div", { className: "w-4 h-4 rounded-full bg-amber-400" }), _jsx("span", { className: "text-[#6B6B80]", children: "Moyen" })] }), _jsxs("div", { className: "flex items-center gap-2", children: [_jsx("div", { className: "w-4 h-4 rounded-full bg-blue-500" }), _jsx("span", { className: "text-[#6B6B80]", children: "Faible" })] })] }), _jsx("div", { style: { height: '400px', borderRadius: '8px', overflow: 'hidden', border: '1px solid #1F1F2E' }, children: _jsxs(MapContainer, { center: [43.7, 7.12], zoom: 12, style: { height: '100%', width: '100%' }, children: [_jsx(TileLayer, { url: MAPBOX_TILE_URL('streets-v12'), attribution: '\u00A9 Mapbox' }), heatmapData.map((marker, idx) => (_jsx(HeatmapMarker, { position: marker.position, density: marker.density }, idx)))] }) })] }) })] })] }) })), widgetConfig.departments.visible && (_jsx("div", { className: `${widgetConfig.departments.size === 'expanded'
                    ? 'w-full'
                    : widgetConfig.departments.size === 'normal'
                        ? 'w-full'
                        : ''}`, children: _jsxs("div", { className: "relative group", children: [_jsx("div", { className: "absolute -left-8 top-0 opacity-0 group-hover:opacity-100 transition-opacity", children: _jsx(GripHorizontal, { size: 16, className: "text-[#6B6B80]" }) }), _jsxs("div", { className: "tz-card bg-[#12121A] border border-[#1F1F2E] rounded-[var(--tz-radius)]", children: [_jsx("div", { className: "px-6 py-4 border-b border-[#1F1F2E]", children: _jsxs("div", { className: "flex items-center justify-between", children: [_jsxs("div", { children: [_jsx("h3", { className: "font-syne text-base font-bold text-[#F0F0F5]", children: "D\u00E9partements" }), _jsx("p", { className: "text-xs text-[#6B6B80] mt-1", children: "Statut et performance par d\u00E9partement" })] }), _jsxs(Dialog, { open: showNewDeptDialog, onOpenChange: setShowNewDeptDialog, children: [_jsx(DialogTrigger, { asChild: true, children: _jsxs(Button, { size: "sm", className: "gap-1 bg-[#00E5CC] text-[#0A0A0F] hover:bg-[#00E5CC]/80", children: [_jsx(Plus, { size: 14 }), "Nouveau"] }) }), _jsxs(DialogContent, { className: "bg-[#12121A] border border-[#1F1F2E]", children: [_jsxs(DialogHeader, { children: [_jsx(DialogTitle, { className: "text-[#F0F0F5] font-syne", children: "Ajouter un d\u00E9partement" }), _jsx(DialogDescription, { className: "text-[#6B6B80]", children: "Entrez le nom du nouveau d\u00E9partement" })] }), _jsxs("div", { className: "space-y-4", children: [_jsx("input", { type: "text", placeholder: "Nom du d\u00E9partement", value: newDeptName, onChange: (e) => setNewDeptName(e.target.value), className: "w-full px-3 py-2 border border-[#1F1F2E] bg-[#1A1A25] text-[#F0F0F5] rounded-[var(--tz-radius-sm)] focus:outline-none focus:ring-2 focus:ring-[#00E5CC]", onKeyDown: (e) => e.key === 'Enter' && addDepartment() }), _jsxs("div", { className: "flex gap-2 justify-end", children: [_jsx(Button, { variant: "outline", onClick: () => setShowNewDeptDialog(false), className: "border-[#1F1F2E] bg-[#1A1A25] text-[#F0F0F5] hover:bg-[#1E1E2A]", children: "Annuler" }), _jsx(Button, { onClick: addDepartment, className: "bg-[#00E5CC] text-[#0A0A0F] hover:bg-[#00E5CC]/80", children: "Ajouter" })] })] })] })] })] }) }), _jsx("div", { className: "px-6 py-4", children: _jsx("div", { className: "grid gap-4 md:grid-cols-2 lg:grid-cols-4", children: departments.map((dept) => (_jsxs("div", { className: "p-4 rounded-[var(--tz-radius-sm)] border border-[#1F1F2E] hover:border-[#2A2A3D] transition-colors", children: [_jsx("div", { className: "flex items-start justify-between mb-3", children: _jsxs("div", { className: "flex items-center gap-2", children: [_jsx("div", { className: "rounded-[var(--tz-radius-sm)] bg-[rgba(59,130,246,0.1)] p-2", children: _jsx(Building2, { size: 16, className: "text-[#3B82F6]" }) }), _jsxs("div", { children: [_jsx("p", { className: "font-medium text-[#F0F0F5]", children: dept.name }), _jsx("p", { className: "text-xs text-[#6B6B80]", children: "D\u00E9partement" })] })] }) }), _jsxs("div", { className: "space-y-3", children: [_jsxs("div", { children: [_jsx("p", { className: "text-xs text-[#6B6B80] uppercase tracking-wide mb-1", children: "V\u00E9hicules" }), _jsx("p", { className: "text-2xl font-bold font-mono text-[#F0F0F5]", children: dept.vehicleCount })] }), _jsxs("div", { children: [_jsx("p", { className: "text-xs text-[#6B6B80] uppercase tracking-wide mb-1", children: "Chauffeurs actifs" }), _jsx("p", { className: "text-2xl font-bold font-mono text-[#F0F0F5]", children: dept.driverCount })] }), _jsxs("div", { children: [_jsxs("div", { className: "flex items-center justify-between mb-1", children: [_jsx("p", { className: "text-xs font-medium text-[#6B6B80]", children: "Performance" }), _jsxs("p", { className: "text-xs font-bold text-[#F0F0F5]", children: [dept.performanceScore, "%"] })] }), _jsx("div", { className: "h-2 w-full rounded-full bg-[#1A1A25] overflow-hidden", children: _jsx("div", { className: `h-full transition-all ${dept.performanceScore >= 90
                                                                            ? 'bg-[#22C55E]'
                                                                            : dept.performanceScore >= 80
                                                                                ? 'bg-[#FFB547]'
                                                                                : 'bg-[#FF4D6A]'}`, style: { width: `${dept.performanceScore}%` } }) })] })] })] }, dept.id))) }) })] })] }) })), _jsxs("div", { className: "grid gap-6 auto-rows-max md:grid-cols-2 lg:grid-cols-4", children: [widgetConfig['fleet-activity'].visible && (_jsx("div", { className: `${widgetConfig['fleet-activity'].size === 'expanded'
                            ? 'md:col-span-2 lg:col-span-4'
                            : widgetConfig['fleet-activity'].size === 'normal'
                                ? 'md:col-span-2 lg:col-span-3'
                                : 'md:col-span-1 lg:col-span-1'}`, children: _jsxs("div", { className: "relative group", children: [_jsx("div", { className: "absolute -left-8 top-0 opacity-0 group-hover:opacity-100 transition-opacity", children: _jsx(GripHorizontal, { size: 16, className: "text-[#6B6B80]" }) }), _jsxs("div", { className: "tz-card bg-[#12121A] border border-[#1F1F2E] rounded-[var(--tz-radius)]", children: [_jsx("div", { className: "px-6 py-4 border-b border-[#1F1F2E]", children: _jsxs("div", { className: "flex items-center justify-between", children: [_jsxs("div", { children: [_jsx("h3", { className: "font-syne text-base font-bold text-[#F0F0F5]", children: "Activit\u00E9 de la flotte" }), _jsx("p", { className: "text-xs text-[#6B6B80] mt-1", children: "V\u00E9hicules avec position GPS, tri\u00E9s par vitesse" })] }), _jsxs(Button, { variant: "ghost", size: "sm", className: "gap-1 text-xs text-[#00E5CC] hover:bg-[#1A1A25]", onClick: () => navigate('/map'), children: ["Carte", _jsx(ChevronRight, { size: 14 })] })] }) }), _jsxs("div", { className: "px-6 py-4", children: [_jsx("div", { className: "space-y-2", children: topMoving.map((vehicle) => {
                                                        const isMoving = (vehicle.currentSpeed || 0) > 2;
                                                        return (_jsxs("div", { className: "flex items-center gap-3 rounded-[var(--tz-radius-sm)] border border-[#1F1F2E] p-3 hover:bg-[#1A1A25] cursor-pointer transition-colors", onClick: () => navigate(`/vehicles/${vehicle.id}`), children: [_jsx("span", { className: `h-2.5 w-2.5 rounded-full flex-shrink-0 ${isMoving ? 'bg-[#22C55E]' : 'bg-[#6B6B80]'}` }), _jsxs("div", { className: "flex-1 min-w-0", children: [_jsx("p", { className: "text-sm font-medium text-[#F0F0F5] truncate", children: vehicle.name }), _jsx("p", { className: "text-xs text-[#6B6B80]", children: vehicle.plate })] }), _jsx("div", { className: "text-right flex-shrink-0", children: _jsxs("p", { className: "text-sm font-bold font-mono text-[#F0F0F5]", children: [(vehicle.currentSpeed || 0).toFixed(0), ' ', _jsx("span", { className: "text-xs font-normal text-[#6B6B80]", children: "km/h" })] }) }), _jsx("div", { className: "text-right flex-shrink-0 min-w-20", children: _jsx("p", { className: "text-xs text-[#44445A]", children: formatTimeAgo(vehicle.lastCommunication) }) }), _jsx(ChevronRight, { size: 14, className: "text-[#44445A]" })] }, vehicle.id));
                                                    }) }), _jsx(Button, { variant: "outline", className: "mt-4 w-full text-sm border-[#1F1F2E] bg-[#1A1A25] text-[#F0F0F5] hover:bg-[#1E1E2A]", onClick: () => navigate('/vehicles'), children: "Voir tous les v\u00E9hicules" })] })] })] }) })), widgetConfig.providers.visible && (_jsx("div", { className: `${widgetConfig.providers.size === 'expanded'
                            ? 'md:col-span-2 lg:col-span-4'
                            : widgetConfig.providers.size === 'normal'
                                ? 'md:col-span-2 lg:col-span-1'
                                : 'md:col-span-1 lg:col-span-1'}`, children: _jsxs("div", { className: "relative group", children: [_jsx("div", { className: "absolute -left-8 top-0 opacity-0 group-hover:opacity-100 transition-opacity", children: _jsx(GripHorizontal, { size: 16, className: "text-[#6B6B80]" }) }), _jsxs("div", { className: "tz-card bg-[#12121A] border border-[#1F1F2E] rounded-[var(--tz-radius)]", children: [_jsxs("div", { className: "px-6 py-4 border-b border-[#1F1F2E]", children: [_jsx("h3", { className: "font-syne text-base font-bold text-[#F0F0F5]", children: "Fournisseurs GPS" }), _jsx("p", { className: "text-xs text-[#6B6B80] mt-1", children: "R\u00E9partition par provider" })] }), _jsxs("div", { className: "px-6 py-4", children: [_jsx("div", { className: "space-y-3", children: Object.entries(stats.providers)
                                                        .sort(([, a], [, b]) => b - a)
                                                        .map(([name, count]) => {
                                                        const pct = stats.total > 0 ? (count / stats.total) * 100 : 0;
                                                        return (_jsxs("div", { children: [_jsxs("div", { className: "flex items-center justify-between text-sm mb-1", children: [_jsxs("div", { className: "flex items-center gap-2", children: [_jsx("span", { className: `h-3 w-3 rounded-full ${providerColors[name] || 'bg-[#6B6B80]'}` }), _jsx("span", { className: "font-medium text-[#F0F0F5]", children: name })] }), _jsx("span", { className: "text-[#6B6B80] font-medium", children: count })] }), _jsx("div", { className: "h-2 w-full rounded-full bg-[#1A1A25]", children: _jsx("div", { className: `h-2 rounded-full ${providerColors[name] || 'bg-[#6B6B80]'} transition-all`, style: { width: `${pct}%` } }) })] }, name));
                                                    }) }), _jsx("div", { className: "mt-4 pt-3 border-t border-[#1F1F2E] text-center", children: _jsxs("p", { className: "text-xs text-[#6B6B80]", children: ["Vitesse max: ", _jsxs("span", { className: "font-bold text-[#F0F0F5]", children: [stats.maxSpeed.toFixed(0), " km/h"] }), ' · ', "Moyenne: ", _jsxs("span", { className: "font-bold text-[#F0F0F5]", children: [stats.avgSpeed.toFixed(0), " km/h"] })] }) })] })] })] }) })), widgetConfig['recent-updates'].visible && (_jsx("div", { className: `${widgetConfig['recent-updates'].size === 'expanded'
                            ? 'md:col-span-2 lg:col-span-4'
                            : widgetConfig['recent-updates'].size === 'normal'
                                ? 'md:col-span-2 lg:col-span-1'
                                : 'md:col-span-1 lg:col-span-1'}`, children: _jsxs("div", { className: "relative group", children: [_jsx("div", { className: "absolute -left-8 top-0 opacity-0 group-hover:opacity-100 transition-opacity", children: _jsx(GripHorizontal, { size: 16, className: "text-[#6B6B80]" }) }), _jsxs("div", { className: "tz-card bg-[#12121A] border border-[#1F1F2E] rounded-[var(--tz-radius)]", children: [_jsx("div", { className: "px-6 py-4 border-b border-[#1F1F2E]", children: _jsx("h3", { className: "font-syne text-base font-bold text-[#F0F0F5]", children: "Mises \u00E0 jour r\u00E9centes" }) }), _jsx("div", { className: "px-6 py-4", children: _jsx("div", { className: "space-y-2.5", children: recentlyUpdated.map((v) => (_jsxs("div", { className: "flex items-center gap-2 text-xs", children: [_jsx(Clock, { size: 12, className: "text-[#6B6B80] flex-shrink-0" }), _jsx("span", { className: "font-medium text-[#F0F0F5] truncate flex-1", children: v.name }), _jsx("span", { className: "text-[#44445A] flex-shrink-0", children: formatTimeAgo(v.lastCommunication) })] }, v.id))) }) })] })] }) }))] })] }));
}
