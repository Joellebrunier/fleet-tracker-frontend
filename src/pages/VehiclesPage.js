...
export default function VehiclesPage() {
    ...
    return (_jsxs("div", { className: "space-y-6 bg-[#0A0A0F] min-h-screen p-6", children: [_jsx("div", { className: "flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-center", children: _jsxs("div", { children: [_jsx("h1", { className: "text-3xl font-bold text-[#F0F0F5] font-syne", children: "Catalogue V\u00E9hicules" }), _jsx("p", { className: "text-sm text-[#6B6B80] mt-1", children: "Gestion de la flotte Mat\u00E9riel Tech+" })] }) }), _jsx("div", { className: "border-b border-[#1F1F2E]", children: _jsxs("div", { className: "flex gap-8", children: [_jsxs("button", { onClick: () => setActiveTab('vehicles'), className: `py-3 px-1 border-b-2 font-semibold text-sm transition-colors ${activeTab === 'vehicles'
                                ...
                                ? 'border-[#00E5CC] text-[#00E5CC]'
                                : 'border-transparent text-[#6B6B80] hover:text-[#F0F0F5]'}`, children: ["GROUPES (", groups.length, ")"] })] }) }), _jsxs("div", { className: "flex flex-wrap gap-2", children: [_jsxs(Button, { variant: "outline", size: "sm", className: "gap-2 text-[#F0F0F5] bg-[#1A1A25] border-[#1F1F2E] hover:bg-[#1E1E2A]", onClick: () => setIsImportDialogOpen(true), children: [_jsx(Upload, { size: 16 }), "IMPORTER"] }), _jsxs("div", { className: "relative", children: [_jsxs(Button, { variant: "outline", size: "sm", className: "gap-2 text-[#F0F0F5] bg-[#1A1A25] border-[#1F1F2E] hover:bg-[#1E1E2A]", onClick: () => setShowExportMenu(!showExportMenu), children: [_jsx(FileDown, { size: 16 }), "EXPORTER"] }), showExportMenu && (_jsxs("div", { className: "absolute top-10 left-0 bg-[#12121A] border border-[#1F1F2E] rounded-[8px] shadow-lg z-50 w-48", children: [_jsx("button", { onClick: () => { exportToCSV(); setShowExportMenu(false); }, className: "w-full text-left px-4 py-2 text-sm text-[#F0F0F5] hover:bg-[#1A1A25] border-b border-[#1F1F2E]", children: "CSV (Tous)" }), _jsx("button", { onClick: () => { exportToFormat('xlsx'); setShowExportMenu(false); }, className: "w-full text-left px-4 py-2 text-sm text-[#F0F0F5] hover:bg-[#1A1A25] border-b border-[#1F1F2E]", children: "Excel XLSX" }), _jsx("button", { onClick: () => { exportToFormat('kml'); setShowExportMenu(false); }, className: "w-full text-left px-4 py-2 text-sm text-[#F0F0F5] hover:bg-[#1A1A25] border-b border-[#1F1F2E]", children: "Google Earth (KML)" }), _jsx("button", { onClick: () => { exportToFormat('gpx'); setShowExportMenu(false); }, className: "w-full text-left px-4 py-2 text-sm text-[#F0F0F5] hover:bg-[#1A1A25]", children: "GPS Format (GPX)" })] }))] }), _jsxs(Button, { variant: "outline", size: "sm", className: "gap-2 text-[#F0F0F5] bg-[#1A1A25] border-[#1F1F2E] hover:bg-[#1E1E2A]", onClick: exportConducteursCSV, children: [_jsx(FileDown, { size: 16 }), "CONDUCTEURS CSV"] }), _jsxs(Button, { variant: "outline", size: "sm", className: "gap-2 text-[#F0F0F5] bg-[#1A1A25] border-[#1F1F2E] hover:bg-[#1E1E2A]", onClick: () => setShowScheduledExports(!showScheduledExports), children: [_jsx(Clock, { size: 16 }), "EXPORTS PROGRAMM\u00C9S"] }), _jsx(Button, { variant: "outline", size: "sm", className: "gap-2 text-[#F0F0F5] bg-[#1A1A25] border-[#1F1F2E] hover:bg-[#1E1E2A]", children: "R\u00D4LES" }), _jsx(Button, { variant: "outline", size: "sm", className: "gap-2 text-[#F0F0F5] bg-[#1A1A25] border-[#1F1F2E] hover:bg-[#1E1E2A]", children: "AUDIT" }), _jsx(Button, { variant: "outline", size: "sm", className: "gap-2 text-[#F0F0F5] bg-[#1A1A25] border-[#1F1F2E] hover:bg-[#1E1E2A]", children: "ATTRIBUTION" })] }), _jsxs("div", { className: "flex flex-col gap-4 sm:flex-row sm:items-center", children: [_jsx("div", { className: "flex-1", children: _jsxs("div", { className: "relative", children: [_jsx(Search, { className: "absolute left-3 top-3 text-[#44445A]", size: 18 }), _jsx(Input, { type: "search", placeholder: "Rechercher par nom ou immatriculation...", value: searchTerm, onChange: (e) => {
