    ...
    return (_jsxs("div", { className: "space-y-6", children: [_jsxs("div", { className: "flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between", children: [_jsxs("div", { children: [_jsx("h1", { className: "text-3xl font-bold text-gray-900", children: "G\u00E9ocl\u00F4tures" }), _jsx("p", { className: "mt-1 text-gray-600", children: "Cr\u00E9er et g\u00E9rer les limites de localisation pour votre flotte" })] }), _jsxs("div", { className: "flex gap-2", children: [_jsxs("div", { className: "relative", children: [_jsx(Button, { variant: "outline", className: "gap-2", onClick: () => setShowTemplates(!showTemplates), children: "Mod\u00E8les" }), showTemplates && (_jsx("div", { className: "absolute right-0 mt-1 w-64 bg-white rounded-lg shadow-lg border border-gray-200 z-10", children: _jsx("div", { className: "p-2 space-y-1", children: geofenceTemplates.map((template) => (_jsx("button", { onClick: () => {
                                ...
                                : 'Cliquez sur "Créer" pour définir votre première zone' }), !search && (_jsxs(Button, { className: "mt-4 gap-2", onClick: openCreateModal, children: [_jsx(Plus, { size: 16 }), "Cr\u00E9er votre premi\u00E8re g\u00E9ocl\u00F4ture"] }))] }) })) : (_jsx("div", { className: "grid gap-4 lg:grid-cols-2", children: filteredGeofences.map((geofence) => (_jsxs(Card, { className: "cursor-pointer transition-shadow hover:shadow-md", onClick: () => openViewModal(geofence), children: [_jsx(CardHeader, { className: "pb-3", children: _jsxs("div", { className: "flex items-start justify-between", children: [_jsxs("div", { className: "flex items-center gap-2 flex-1", children: [_jsx("div", { className: "rounded-lg p-2", style: {
                                                            ...
                                                            : 'border-gray-300 bg-white text-gray-600 hover:border-gray-400'}`, children: day }, idx))) }), _jsx("p", { className: "mt-1 text-xs text-gray-500", children: getDayLabel(form.activeDays) })] }), _jsxs("div", { className: "sm:col-span-2", children: [_jsx("label", { className: "mb-2 block text-sm font-medium text-gray-700", children: "Heures actives" }), _jsx("div", { className: "flex items-center gap-2", children: _jsxs("label", { className: "flex items-center gap-2 text-sm", children: [_jsx("input", { type: "checkbox", checked: !!form.activeHours, onChange: (e) => {
                                                                ...
                                                                setForm((prev) => ({
                                                                    ...
                                                                    activeHours: {
                                                                        ...
                                                                        }, className: "rounded border-gray-300" }), _jsxs("div", { className: "flex-1", children: [_jsx("p", { className: "font-medium", children: vehicle.name }), _jsx("p", { className: "text-xs text-gray-500", children: vehicle.registration })] })] }, vehicle.id))) })), form.assignedVehicleIds.length > 0 && (_jsxs("div", { className: "mt-2 space-y-1", children: [_jsxs("p", { className: "text-xs font-medium text-gray-700", children: ["Assign\u00E9s (", form.assignedVehicleIds.length, "):"] }), _jsx("div", { className: "flex flex-wrap gap-1", children: form.assignedVehicleIds.map((vehicleId) => {
                                                                        const vehicle = vehicles.find((v) => v.id === vehicleId);
                                                                        return (_jsxs(Badge, { variant: "secondary", className: "gap-1 text-xs", children: [vehicle?.name, _jsx("button", { onClick: () => {
                                                                                        setForm((prev) => ({
                                                                                            ...prev,
                                        ...
                                        : modalMode === 'create'
                                            ...
                                            : 'Enregistrer les modifications' })] })] }) }), _jsx(Dialog, { open: modalMode === 'view', onOpenChange: () => closeModal(), children: _jsxs(DialogContent, { className: "max-w-2xl max-h-[90vh] overflow-y-auto", children: [_jsxs(DialogHeader, { children: [_jsx(DialogTitle, { children: selectedGeofence?.name }), _jsx(DialogDescription, { children: selectedGeofence?.description || 'Pas de description' })] }), selectedGeofence && (_jsxs("div", { className: "space-y-4", children: [_jsxs("div", { className: "flex gap-4 border-b border-gray-200", children: [_jsx("button", { onClick: () => setActiveTab('details'), className: `pb-2 px-1 text-sm font-medium transition-colors ${activeTab === 'details'
                                                ? 'border-b-2 border-blue-500 text-blue-600'
                                                : 'text-gray-600 hover:text-gray-900'}`, children: "D\u00E9tails" }), _jsx("button", { onClick: () => setActiveTab('history'), className: `pb-2 px-1 text-sm font-medium transition-colors ${activeTab === 'history'
                                                ? 'border-b-2 border-blue-500 text-blue-600'
                                                : 'text-gray-600 hover:text-gray-900'}`, children: "Historique" })] }), activeTab === 'details' && (_jsxs("div", { className: "space-y-4", children: [_jsx(GeofenceDrawMap, { initialShape: selectedGeofence.shape, onShapeChange: () => { } }, `view-${selectedGeofence.id}`), _jsxs("div", { className: "grid grid-cols-2 gap-4 text-sm", children: [_jsxs("div", { children: [_jsx("p", { className: "text-gray-500", children: "Statut" }), _jsx(Badge, { variant: selectedGeofence.isActive ? 'default' : 'secondary', children: selectedGeofence.isActive ? 'Actif' : 'Inactif' })] }), _jsxs("div", { children: [_jsx("p", { className: "text-gray-500", children: "Forme" }), _jsx("p", { className: "font-medium", children: getShapeLabel(selectedGeofence.shape) })] }), _jsxs("div", { children: [_jsx("p", { className: "text-gray-500", children: "D\u00E9clencheur" }), _jsx("p", { className: "font-medium capitalize", children: selectedGeofence.triggerEvent })] }), _jsxs("div", { children: [_jsx("p", { className: "text-gray-500", children: "Cr\u00E9\u00E9" }), _jsx("p", { className: "font-medium", children: formatDateTime(selectedGeofence.createdAt) })] }), _jsxs("div", { children: [_jsx("p", { className: "text-gray-500", children: "Alerte \u00E0 l'entr\u00E9e" }), _jsx("p", { className: "font-medium", children: selectedGeofence.alertOnEntry ? 'Oui' : 'Non' })] }), _jsxs("div", { children: [_jsx("p", { className: "text-gray-500", children: "Alerte \u00E0 la sortie" }), _jsx("p", { className: "font-medium", children: selectedGeofence.alertOnExit ? 'Oui' : 'Non' })] }), getVehiclesInsideCount(selectedGeofence) > 0 && (_jsxs("div", { children: [_jsx("p", { className: "text-gray-500", children: "V\u00E9hicules \u00E0 l'int\u00E9rieur" }), _jsx("p", { className: "font-medium text-green-600", children: getVehiclesInsideCount(selectedGeofence) })] }))] })] })), activeTab === 'history' && (_jsx("div", { className: "space-y-3", children: violationsLoading ? (_jsx("div", { className: "flex justify-center py-8", children: _jsx("div", { className: "text-gray-600", children: "Chargement de l'historique..." }) })) : violations.length === 0 ? (_jsxs("div", { className: "rounded-lg bg-gray-50 px-4 py-6 text-center", children: [_jsx(Clock, { className: "mx-auto mb-2 text-gray-400", size: 24 }), _jsx("p", { className: "text-sm text-gray-600", children: "Aucun \u00E9v\u00E9nement enregistr\u00E9" })] })) : (_jsx("div", { className: "max-h-96 overflow-y-auto space-y-2", children: violations.map((violation) => (_jsx("div", { className: `flex items-start justify-between rounded-lg px-3 py-2 ${violation.type === 'entry'
                                                ? 'bg-green-50 border border-green-200'
                                                : 'bg-orange-50 border border-orange-200'}`, children: _jsxs("div", { className: "flex-1", children: [_jsxs("div", { className: "flex items-center gap-2", children: [_jsx(Badge, { variant: violation.type === 'entry' ? 'default' : 'secondary', className: `text-xs ${violation.type === 'entry'
                                                                    ? 'bg-green-600'
                                                                    : 'bg-orange-600 text-white'}`, children: violation.type === 'entry' ? 'Entrée' : 'Sortie' }), _jsx("span", { className: "font-medium text-sm", children: violation.vehicleName })] }), _jsx("p", { className: "text-xs text-gray-600 mt-1", children: formatDateTime(violation.timestamp) })] }) }, violation.id))) })) }))] })), _jsxs(DialogFooter, { children: [_jsx(Button, { variant: "outline", onClick: closeModal, children: "Fermer" }), _jsx(Button, { onClick: () => {
                                        if (selectedGeofence) {
                                            closeModal();
