...
export default function HelpPage() {
  return (
    <div className="space-y-6 p-6">
      <div>
        <h1 className="text-3xl font-bold text-gray-900">Aide et documentation</h1>
        <p className="mt-1 text-sm text-gray-600">Trouvez des réponses à vos questions et apprenez à utiliser TrackZone</p>
      </div>
      ...
      <div className="grid gap-4 sm:grid-cols-3">
        <Card className="hover:shadow-md transition-shadow cursor-pointer">
          <CardContent className="pt-6 text-center">
            ...
            <p className="text-sm text-gray-500 mt-1">Apprenez les bases de TrackZone</p>
          </CardContent>
        </Card>
        <Card className="hover:shadow-md transition-shadow cursor-pointer">
          <CardContent className="pt-6 text-center">
            <Globe size={32} className="mx-auto mb-3 text-green-600" />
            <p className="font-medium text-gray-900">Documentation API</p>
            <p className="text-sm text-gray-500 mt-1">Intégrez TrackZone à vos systèmes</p>
          </CardContent>
        </Card>
        <Card className="hover:shadow-md transition-shadow cursor-pointer">
          <CardContent className="pt-6 text-center">
            <Mail size={32} className="mx-auto mb-3 text-purple-600" />
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Naviguez plus rapidement avec ces raccourcis</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="grid gap-2 sm:grid-cols-2">
            {shortcuts.map(s => (
              <div key={s.key} className="flex items-center gap-3 p-2 rounded hover:bg-gray-50">
                <kbd className="px-2 py-1 bg-gray-100 border border-gray-200 rounded text-xs font-mono font-bold text-gray-700 min-w-[32px] text-center">
                  {s.key}
                </kbd>
