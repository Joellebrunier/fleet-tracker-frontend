...
export default function TestEnvironmentPage() {
    ...
    return (_jsxs("div", { className: "space-y-6", children: [_jsxs("div", { children: [_jsx("h1", { className: "text-3xl font-bold text-gray-900", children: "Environnement de test" }), _jsx("p", { className: "mt-2 text-gray-600", children: "Testez l'API TrackZone avant la mise en production" })] }), _jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-3 gap-6", children: [_jsxs("div", { className: "lg:col-span-2 space-y-6", children: [_jsxs(Card, { children: [_jsx(CardHeader, { children: _jsx(CardTitle, { className: "text-base", children: "Configuration" }) }), _jsxs(CardContent, { className: "space-y-4", children: [_jsxs("div", { children: [_jsx("label", { className: "block text-sm font-medium text-gray-900 mb-2", children: "Environnement" }), _jsx("div", { className: "flex gap-2", children: Object.keys(baseUrls).map((env) => (_jsx("button", { onClick: () => setEnvironment(env), className: cn('px-4 py-2 rounded-lg font-medium transition-colors', environment === env
                                                                ? 'bg-blue-600 text-white'
                                                                : 'bg-gray-200 text-gray-900 hover:bg-gray-300'), children: env.charAt(0).toUpperCase() + env.slice(1) }, env))) })] }), _jsxs("div", { className: "flex items-center gap-4", children: [_jsxs("label", { className: "flex items-center gap-2", children: [_jsx("input", { type: "checkbox", checked: sandboxMode, onChange: (e) => setSandboxMode(e.target.checked), className: "rounded" }), _jsx("span", { className: "text-sm font-medium text-gray-900", children: "Mode Sandbox" })] }), sandboxMode && (_jsx(Badge, { variant: "secondary", children: "Donn\u00E9es fictives" }))] })] })] }), _jsxs(Card, { children: [_jsx(CardHeader, { children: _jsx(CardTitle, { className: "text-base", children: "Testeur de requ\u00EAte" }) }), _jsxs(CardContent, { className: "space-y-4", children: [_jsxs("div", { className: "flex gap-2", children: [_jsxs("select", { value: method, onChange: (e) => setMethod(e.target.value), className: "px-3 py-2 border border-gray-300 rounded-lg font-medium bg-white", children: [_jsx("option", { children: "GET" }), _jsx("option", { children: "POST" }), _jsx("option", { children: "PUT" }), _jsx("option", { children: "DELETE" })] }), _jsx(Input, { placeholder: "/api/vehicles", value: url, onChange: (e) => setUrl(e.target.value), className: "flex-1" })] }), method !== 'GET' && (_jsxs("div", { children: [_jsx("label", { className: "block text-sm font-medium text-gray-900 mb-2", children: "Body (JSON)" }), _jsx("textarea", { value: body, onChange: (e) => setBody(e.target.value), placeholder: '{"name": "..."}', className: "w-full px-3 py-2 border border-gray-300 rounded-lg font-mono text-sm h-40 resize-none" })] })), _jsxs(Button, { onClick: handleSendRequest, disabled: loading || !url, className: "w-full", children: [_jsx(Send, { size: 16, className: "mr-2" }), loading ? 'Envoi...' : 'Envoyer la requête'] })] })] }), response && (_jsxs(Card, { className: response.status && response.status >= 200 && response.status < 300
                                    ? 'border-green-200 bg-green-50'
                                    : response.error
                                        ? 'border-red-200 bg-red-50'
                                        : 'border-blue-200 bg-blue-50', children: [_jsx(CardHeader, { children: _jsxs("div", { className: "flex items-center justify-between", children: [_jsx(CardTitle, { className: "text-base", children: "R\u00E9ponse" }), _jsxs(Badge, { variant: response.status && response.status >= 200 && response.status < 300
                                                        ? 'default'
                                                        : 'destructive', children: [response.status || 'Erreur', " ", response.statusText || ''] })] }) }), _jsx(CardContent, { children: _jsx("div", { className: "bg-gray-900 text-gray-100 p-4 rounded-lg font-mono text-xs overflow-x-auto", children: _jsx("code", { className: "whitespace-pre-wrap break-words", children: JSON.stringify(response.data || response.error || response, null, 2) }) }) })] }))] }), _jsxs("div", { className: "space-y-6", children: [_jsxs(Card, { children: [_jsx(CardHeader, { children: _jsx(CardTitle, { className: "text-base", children: "G\u00E9n\u00E9rateur de donn\u00E9es" }) }), _jsxs(CardContent, { className: "space-y-2", children: [_jsx(Button, { variant: "outline", className: "w-full justify-start", onClick: () => handleGenerateMockData('vehicles'), children: "10 V\u00E9hicules" }), _jsx(Button, { variant: "outline", className: "w-full justify-start", onClick: () => handleGenerateMockData('drivers'), children: "5 Conducteurs" }), _jsx(Button, { variant: "outline", className: "w-full justify-start", onClick: () => handleGenerateMockData('geofences'), children: "3 G\u00E9ofences" })] })] }), _jsxs(Card, { children: [_jsx(CardHeader, { children: _jsxs("div", { className: "flex items-center justify-between", children: [_jsx(CardTitle, { className: "text-base", children: "Historique" }), requestHistory.length > 0 && (_jsx("button", { onClick: clearHistory, className: "p-1 hover:bg-gray-200 rounded", children: _jsx(Trash2, { size: 16 }) }))] }) }), _jsx(CardContent, { className: "space-y-2 max-h-80 overflow-y-auto", children: requestHistory.length === 0 ? (_jsx("p", { className: "text-sm text-gray-500", children: "Aucune requ\u00EAte" })) : (requestHistory.map((item) => (_jsxs("button", { onClick: () => handleHistoryClick(item), className: "w-full text-left p-2 hover:bg-gray-100 rounded-lg border border-gray-200 transition-colors", children: [_jsxs("div", { className: "flex items-center justify-between gap-2 mb-1", children: [_jsx(Badge, { variant: getMethodBadgeVariant(item.method), children: item.method }), item.status && (_jsx("span", { className: cn('text-xs font-medium', item.status >= 200 && item.status < 300
                                                                ? 'text-green-700'
                                                                : 'text-red-700'), children: item.status }))] }), _jsx("p", { className: "text-xs text-gray-600 truncate", children: item.url }), _jsx("p", { className: "text-xs text-gray-500", children: item.timestamp.toLocaleTimeString() })] }, item.id)))) })] }), _jsxs(Card, { children: [_jsx(CardHeader, { children: _jsx(CardTitle, { className: "text-base", children: "Documentation" }) }), _jsxs(CardContent, { className: "space-y-2", children: [_jsx("p", { className: "text-sm text-gray-600", children: "Besoin d'aide pour les endpoints ?" }), _jsx(Button, { variant: "outline", className: "w-full justify-start text-blue-600 hover:text-blue-700", onClick: () => window.open('/api-docs', '_blank'), children: "Consulter la documentation" }), _jsx(Button, { variant: "outline", className: "w-full justify-start text-blue-600 hover:text-blue-700", onClick: () => window.open('/sdk-examples', '_blank'), children: "Voir les exemples SDK" })] })] })] })] })] }));
}
