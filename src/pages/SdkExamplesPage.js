...
export default function SdkExamplesPage() {
    ...
    return (_jsxs("div", { className: "space-y-6", children: [_jsxs("div", { children: [_jsx("h1", { className: "text-3xl font-bold text-gray-900", children: "Exemples SDK" }), _jsx("p", { className: "mt-2 text-gray-600", children: "Int\u00E9grez l'API TrackZone avec votre langage pr\u00E9f\u00E9r\u00E9" })] }), _jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-4 gap-6", children: [_jsx("div", { className: "space-y-4", children: _jsxs(Card, { children: [_jsx(CardHeader, { children: _jsx(CardTitle, { className: "text-base", children: "Exemples" }) }), _jsx(CardContent, { className: "space-y-2", children: Object.keys(examples).map((example) => (_jsx("button", { onClick: () => setSelectedExample(example), className: cn('w-full text-left px-4 py-2 rounded-lg transition-colors', selectedExample === example
                                            ? 'bg-blue-600 text-white'
                                            : 'hover:bg-gray-100'), children: examples[example].title }, example))) })] }) }), _jsxs("div", { className: "lg:col-span-3 space-y-6", children: [_jsx(Card, { children: _jsx(CardContent, { className: "pt-6", children: _jsx("div", { className: "flex gap-2 flex-wrap", children: languages.map((lang) => (_jsx("button", { onClick: () => setSelectedLanguage(lang.id), className: cn('px-4 py-2 rounded-lg font-medium transition-colors', selectedLanguage === lang.id
                                                ? 'bg-blue-600 text-white'
                                                : 'bg-gray-200 text-gray-900 hover:bg-gray-300'), children: lang.label }, lang.id))) }) }) }), _jsxs(Card, { children: [_jsx(CardHeader, { children: _jsxs("div", { className: "flex items-start justify-between", children: [_jsxs("div", { children: [_jsx(CardTitle, { children: currentExample.title }), _jsx("p", { className: "text-sm text-gray-600 mt-2", children: currentExample.description })] }), _jsx(Button, { variant: "outline", size: "sm", onClick: () => copyToClipboard(currentCode, selectedExample), className: "ml-2", children: copiedSnippet === selectedExample ? (_jsxs(_Fragment, { children: [_jsx(Check, { size: 16, className: "mr-2" }), "Copi\u00E9"] })) : (_jsxs(_Fragment, { children: [_jsx(Copy, { size: 16, className: "mr-2" }), "Copier"] })) })] }) }), _jsx(CardContent, { children: _jsx("div", { className: "bg-gray-900 text-gray-100 p-4 rounded-lg font-mono text-sm overflow-x-auto", children: _jsx("code", { className: "whitespace-pre-wrap break-words", children: currentCode }) }) })] }), _jsxs(Card, { children: [_jsx(CardHeader, { children: _jsx(CardTitle, { className: "text-base", children: "Configuration des Webhooks" }) }), _jsxs(CardContent, { className: "space-y-4", children: [_jsx("p", { className: "text-gray-600", children: "Recevez des notifications en temps r\u00E9el pour les \u00E9v\u00E9nements de votre flotte." }), _jsxs("div", { children: [_jsx("h3", { className: "font-semibold text-gray-900 mb-2", children: "Types d'\u00E9v\u00E9nements" }), _jsxs("ul", { className: "space-y-2 text-sm text-gray-600", children: [_jsxs("li", { children: [_jsx("code", { className: "bg-gray-100 px-2 py-1 rounded", children: "geofence.entered" }), "- V\u00E9hicule entr\u00E9 dans une zone"] }), _jsxs("li", { children: [_jsx("code", { className: "bg-gray-100 px-2 py-1 rounded", children: "geofence.exited" }), "- V\u00E9hicule sorti d'une zone"] }), _jsxs("li", { children: [_jsx("code", { className: "bg-gray-100 px-2 py-1 rounded", children: "alert.triggered" }), "- Alerte d\u00E9clench\u00E9e"] }), _jsxs("li", { children: [_jsx("code", { className: "bg-gray-100 px-2 py-1 rounded", children: "vehicle.offline" }), "- V\u00E9hicule hors ligne"] }), _jsxs("li", { children: [_jsx("code", { className: "bg-gray-100 px-2 py-1 rounded", children: "gps.update" }), "- Mise \u00E0 jour GPS re\u00E7ue"] })] })] }), _jsxs("div", { children: [_jsx("h3", { className: "font-semibold text-gray-900 mb-2", children: "Exemple de payload" }), _jsx("div", { className: "bg-gray-900 text-gray-100 p-4 rounded-lg font-mono text-sm overflow-x-auto", children: _jsx("code", { children: `{
  "id": "webhook_123",
