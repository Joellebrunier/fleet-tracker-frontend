import { Vehicle, VehicleListQuery, VehicleFormData } from '@/types/vehicle';
...
export declare function useVehicleStats(id: string): import("@tanstack/react-query").UseQueryResult<null, Error>;
export declare function useVehicleGroups(): import("@tanstack/react-query").UseQueryResult<never[], Error>;
