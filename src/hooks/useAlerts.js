...
export function useAlerts(filters = {}) {
    ...
    return useQuery({
        ...
        queryFn: async () => {
            ...
            const response = await apiClient.get(`${API_ROUTES.ALERTS}?${params}`);
...
export function useAlert(id) {
    return useQuery({
        ...
        queryFn: async () => {
            const response = await apiClient.get(API_ROUTES.ALERT_DETAIL(id));
            return response.data;
        },
        enabled: !!id,
    });
...
export function useAlertRules() {
    return useQuery({
        ...
        queryFn: async () => {
            const response = await apiClient.get(API_ROUTES.ALERT_RULES);
            return response.data;
        },
...
export function useAcknowledgeAlert(alertId) {
    ...
    return useMutation({
        mutationFn: async () => {
            const response = await apiClient.post(API_ROUTES.ALERT_ACKNOWLEDGE(alertId), {});
            return response.data;
        },
        onSuccess: () => {
...
export function useCreateAlertRule() {
    ...
    return useMutation({
        mutationFn: async (data) => {
            const response = await apiClient.post(API_ROUTES.ALERT_RULES, data);
            return response.data;
        },
        onSuccess: () => {
...
export function useUpdateAlertRule(id) {
    ...
    return useMutation({
        mutationFn: async (data) => {
            const response = await apiClient.put(API_ROUTES.ALERT_RULE_DETAIL(id), data);
            return response.data;
        },
        onSuccess: () => {
            queryClient.invalidateQueries({ queryKey: alertKeys.rules });
