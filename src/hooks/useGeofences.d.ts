import { Geofence, GeofenceFormData, GeofenceStats } from '@/types/geofence';
...
export declare function useGeofenceViolations(id: string): import("@tanstack/react-query").UseQueryResult<{
    data: never[];
    totalCount: number;
}, Error>;
