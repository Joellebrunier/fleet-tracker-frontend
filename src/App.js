...
function App() {
    ...
    return (_jsx(Suspense, { fallback: _jsx(PageLoader, {}), children: _jsxs(Routes, { children: [_jsx(Route, { path: "/login", element: isAuthenticated ? _jsx(Navigate, { to: "/", replace: true }) : _jsx(LoginPage, {}) }), _jsx(Route, { path: "/track/:token", element: _jsx(PublicTrackingPage, {}) }), _jsx(Route, { path: "/landing", element: _jsx(LandingPage, {}) }), _jsx(Route, { path: "/legal", element: _jsx(LegalPage, {}) }), _jsx(Route, { path: "/reset-password", element: _jsx(ResetPasswordPage, {}) }), _jsx(Route, { path: "/verify", element: _jsx(VerifyEmailPage, {}) }), _jsx(Route, { path: "/suspended", element: _jsx(SuspendedPage, {}) }), _jsxs(Route, { path: "/driver-app", element: _jsx(ProtectedRoute, { children: _jsx(DriverAppLayout, {}) }), children: [_jsx(Route, { index: true, element: _jsx(DriverAppHome, {}) }), _jsx(Route, { path: "vehicles", element: _jsx(DriverAppVehicles, {}) }), _jsx(Route, { path: "declare", element: _jsx(DriverAppDeclare, {}) }), _jsx(Route, { path: "stations", element: _jsx(DriverAppStations, {}) }), _jsx(Route, { path: "history", element: _jsx(DriverAppHistory, {}) }), _jsx(Route, { path: "profile", element: _jsx(DriverAppProfile, {}) })] }), _jsxs(Route, { element: _jsx(AppLayout, {}), children: [_jsx(Route, { path: "/", element: _jsx(ProtectedRoute, { children: _jsx(DashboardPage, {}) }) }), _jsx(Route, { path: "/map", element: _jsx(ProtectedRoute, { children: _jsx(MapPage, {}) }) }), _jsx(Route, { path: "/vehicles", element: _jsx(ProtectedRoute, { children: _jsx(VehiclesPage, {}) }) }), _jsx(Route, { path: "/vehicles/:id", element: _jsx(ProtectedRoute, { children: _jsx(VehicleDetailPage, {}) }) }), _jsx(Route, { path: "/vehicle-groups", element: _jsx(ProtectedRoute, { children: _jsx(VehicleGroupsPage, {}) }) }), _jsx(Route, { path: "/drivers", element: _jsx(ProtectedRoute, { children: _jsx(DriversPage, {}) }) }), _jsx(Route, { path: "/devices", element: _jsx(ProtectedRoute, { children: _jsx(DevicesPage, {}) }) }), _jsx(Route, { path: "/geofences", element: _jsx(ProtectedRoute, { children: _jsx(GeofencesPage, {}) }) }), _jsx(Route, { path: "/alerts", element: _jsx(ProtectedRoute, { children: _jsx(AlertsPage, {}) }) }), _jsx(Route, { path: "/fourrieres", element: _jsx(ProtectedRoute, { children: _jsx(FourrieresPage, {}) }) }), _jsx(Route, { path: "/reports", element: _jsx(ProtectedRoute, { children: _jsx(ReportsPage, {}) }) }), _jsx(Route, { path: "/settings", element: _jsx(ProtectedRoute, { children: _jsx(SettingsPage, {}) }) }), _jsx(Route, { path: "/profile", element: _jsx(ProtectedRoute, { children: _jsx(ProfilePage, {}) }) }), _jsx(Route, { path: "/support", element: _jsx(ProtectedRoute, { children: _jsx(SupportPage, {}) }) }), _jsx(Route, { path: "/driver-dashboard", element: _jsx(ProtectedRoute, { children: _jsx(DriverDashboardPage, {}) }) }), _jsx(Route, { path: "/shared-links", element: _jsx(ProtectedRoute, { children: _jsx(SharedLinksPage, {}) }) }), _jsx(Route, { path: "/notifications", element: _jsx(ProtectedRoute, { children: _jsx(NotificationsPage, {}) }) }), _jsx(Route, { path: "/maintenance", element: _jsx(ProtectedRoute, { children: _jsx(MaintenancePage, {}) }) }), _jsx(Route, { path: "/client-portal", element: _jsx(ProtectedRoute, { children: _jsx(ClientPortalPage, {}) }) }), _jsx(Route, { path: "/csrd", element: _jsx(ProtectedRoute, { children: _jsx(CSRDPage, {}) }) }), _jsx(Route, { path: "/accounting", element: _jsx(ProtectedRoute, { children: _jsx(AccountingPage, {}) }) }), _jsx(Route, { path: "/recommendations", element: _jsx(ProtectedRoute, { children: _jsx(RecommendationsPage, {}) }) }), _jsx(Route, { path: "/vehicles/archive", element: _jsx(ProtectedRoute, { children: _jsx(VehicleArchivePage, {}) }) }), _jsx(Route, { path: "/onboarding", element: _jsx(ProtectedRoute, { children: _jsx(OnboardingPage, {}) }) }), _jsxs(Route, { path: "/fuel", element: _jsx(ProtectedRoute, { children: _jsx(FuelLayout, {}) }), children: [_jsx(Route, { index: true, element: _jsx(FuelDashboardPage, {}) }), _jsx(Route, { path: "vehicles", element: _jsx(FuelVehiclesPage, {}) }), _jsx(Route, { path: "transactions", element: _jsx(FuelTransactionsPage, {}) }), _jsx(Route, { path: "stations", element: _jsx(FuelStationsPage, {}) }), _jsx(Route, { path: "analysis", element: _jsx(FuelAnalysisPage, {}) }), _jsx(Route, { path: "anomalies", element: _jsx(FuelAnomaliesPage, {}) }), _jsx(Route, { path: "budget", element: _jsx(FuelBudgetPage, {}) }), _jsx(Route, { path: "settings", element: _jsx(FuelSettingsPage, {}) }), _jsx(Route, { path: "validations", element: _jsx(FuelValidationsPage, {}) }), _jsx(Route, { path: "prices", element: _jsx(FuelPricesPage, {}) }), _jsx(Route, { path: "recalculation", element: _jsx(FuelRecalculationPage, {}) }), _jsx(Route, { path: "anomalies/:id", element: _jsx(FuelAnomalyDetailPage, {}) })] }), _jsx(Route, { path: "/help", element: _jsx(ProtectedRoute, { children: _jsx(HelpPage, {}) }) }), _jsx(Route, { path: "/audit-log", element: _jsx(ProtectedRoute, { requiredRoles: [UserRole.ADMIN, UserRole.SUPER_ADMIN], children: _jsx(AuditLogPage, {}) }) }), _jsx(Route, { path: "/roles", element: _jsx(ProtectedRoute, { requiredRoles: [UserRole.ADMIN, UserRole.SUPER_ADMIN], children: _jsx(RolesPermissionsPage, {}) }) }), _jsx(Route, { path: "/admin", element: _jsx(ProtectedRoute, { requiredRoles: [UserRole.ADMIN, UserRole.SUPER_ADMIN], children: _jsx(SuperAdminPage, {}) }) }), _jsx(Route, { path: "/api-docs", element: _jsx(ProtectedRoute, { requiredRoles: [UserRole.ADMIN, UserRole.SUPER_ADMIN], children: _jsx(ApiDocsPage, {}) }) }), _jsx(Route, { path: "/sdk-examples", element: _jsx(ProtectedRoute, { requiredRoles: [UserRole.ADMIN, UserRole.SUPER_ADMIN], children: _jsx(SdkExamplesPage, {}) }) }), _jsx(Route, { path: "/test-environment", element: _jsx(ProtectedRoute, { requiredRoles: [UserRole.ADMIN, UserRole.SUPER_ADMIN], children: _jsx(TestEnvironmentPage, {}) }) }), _jsx(Route, { path: "/organizations", element: _jsx(ProtectedRoute, { requiredRoles: [UserRole.ADMIN, UserRole.SUPER_ADMIN], children: _jsx(OrganizationAdminPage, {}) }) }), _jsx(Route, { path: "/api-diagnostics", element: _jsx(ProtectedRoute, { requiredRoles: [UserRole.ADMIN, UserRole.SUPER_ADMIN], children: _jsx(ApiDiagnosticsPage, {}) }) })] }), _jsx(Route, { path: "*", element: _jsx(Navigate, { to: "/", replace: true }) })] }) }));
}
export default App;
